...
- 2026-08-06T20:03:55+00:00 — `chatgpt-web` — `quality_frontend_tests_aligned` `T-0025`: Aligned three stale frontend tests with the already-shipped core UI contract: WorkspaceChat now asserts DnD and AgentRuns providers rather than removed TTSProvider; Sidebars covers the five active panels and drops removed Console/PDF special panels; tools-menu coverage expects five entries and verifies Preview rather than removed PDF Analysis. Product code unchanged; verification pending.
