...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    usage_description: "Token-Nutzung dieses Chats anzeigen",
    usage_title: "Chat-Nutzung",
    usage_responses: "Antworten: {{count}}",
    usage_prompt_tokens: "Prompt-Tokens: {{count}}",
    usage_completion_tokens: "Antwort-Tokens: {{count}}",
    usage_total_tokens: "Gesamt-Tokens: {{count}}",
  ...
  common: {
    ...
    share_to: "Teilen an",
    shared_notes: "Geteilte Notizen",
    no_other_workspaces: "Keine weiteren Workspaces",
    from: "von",
    ...
    docsLandingSubtitle:
      "Anleitungen für den Alltag — und technische Docs für Admins und Entwickler.",
    ...
    docsAudienceSwitchLabel: "Dokumentations-Zielgruppe",
    docsAudienceUser: "Für Nutzer",
    docsAudienceDeveloper: "Technik",
    docsAudienceUserTitle: "Hilfe & Anleitung",
    docsAudienceDeveloperTitle: "Technische Docs",
    docsAudienceUserDesc:
      "Workspaces, Chat, Dokumente, Recherche und tägliche Arbeitsabläufe.",
    docsAudienceDeveloperDesc:
      "API, Architektur, Deployment, Betrieb, Sicherheit und Runbooks.",
    docsAudienceUserCta: "Nutzer-Docs öffnen",
    docsAudienceDeveloperCta: "Technik-Docs öffnen",
    docsAudienceUserBrowse: "Nutzer-Dokumentation",
    docsAudienceDeveloperBrowse: "Technische Dokumentation",
    docsCategories: {
  ...
  sidebar: {
    ...
    filesystem: {
      ...
      dropHint: "PDF, Dokumente, Bilder, Videos und mehr",
      emptyTitle: "Noch keine Dateien",
      emptyHint: "Laden Sie Dateien hoch oder ziehen Sie sie hierher",
      uploadFirst: "Erste Datei hochladen",
      noSearchResults: "Keine Dateien gefunden",
      uploadSuccess_one: "{{count}} Datei hochgeladen",
      uploadSuccess_other: "{{count}} Dateien hochgeladen",
      uploadFailed: "Upload fehlgeschlagen",
      download: "Herunterladen",
      preview: "Vorschau",
      addedAsContext: "Als Kontext hinzugefügt",
      contextFailed: "Datei konnte nicht als Kontext hinzugefügt werden",
  ...
  feedbackModal: {
    title: "Neues GitHub-Issue",
    filingIn: "Erstellt in {{repo}}",
    project: "Projekt",
    titleLabel: "Titel",
    titlePlaceholder: "Kurze Zusammenfassung",
    descriptionLabel: "Beschreibung",
    descriptionPlaceholder: "Was ist passiert?",
    labels: "Labels",
    label_feedback: "Feedback",
    label_bug: "Bug",
    label_enhancement: "Verbesserung",
    label_question: "Frage",
    createIssue: "Issue erstellen",
    creating: "Wird erstellt…",
    createSuccess: "Issue #{{number}} erstellt",
    createFailed: "Issue konnte nicht erstellt werden.",
    titleTooShort: "Titel muss mindestens 3 Zeichen haben.",
    notConfigured:
      "Feedback-Token ist auf dem Server nicht konfiguriert. Du kannst GitHub öffnen:",
    openGithub: "Auf GitHub öffnen",
    viewOnGithub: "Auf GitHub ansehen",
    createdMessage: "Issue #{{number}} „{{title}}“ wurde erfolgreich erstellt.",
  },
