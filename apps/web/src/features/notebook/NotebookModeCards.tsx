...
export default function NotebookModeCards({
  value,
  onChange,
}: NotebookModeCardsProps) {
  return (
    <div
      role="radiogroup"
        ...
        return (
          ...
          >
            <div className="flex w-full items-center gap-2">
              ...
              {active && (
                <span className="ml-auto h-1.5 w-1.5 rounded-full bg-theme-text-primary" />
              )}
            </div>
            <span className="mt-1.5 hidden text-[11px] leading-4 text-theme-text-secondary sm:block">
              {mode.description}
            </span>
          </button>
        );
