...
export default function NotebookSourceRow({
  source,
  selected,
  onToggle,
  onOpen,
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={
          selected
            ? `${source.title} deaktivieren`
            : `${source.title} aktivieren`
        }
      ...
      >
        ...
        <span className="mt-0.5 block truncate text-[11px] text-theme-text-secondary">
