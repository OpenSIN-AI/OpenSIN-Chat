...
const Note: any = {
  forWorkspace: async function (slug: any, { trash = false }: any = {}) {
    return await fetch(`${API_BASE}/workspaces/${slug}/notes?trash=${trash}`, {
      method: "GET",
      headers: baseHeaders(),
    })
      .then((res) => res.json())
  ...
  create: async function (slug: any, data: any = {}) {
  ...
  update: async function (slug: any, id: any, data: any) {
  ...
  delete: async function (slug: any, id: any, permanent = false) {
    return await fetch(
      `${API_BASE}/workspaces/${slug}/notes/${id}?permanent=${permanent}`,
  ...
  restore: async function (slug: any, id: any) {
    return await fetch(`${API_BASE}/workspaces/${slug}/notes/${id}/restore`, {
      method: "POST",
      headers: baseHeaders(),
    })
      .then((res) => res.json())
