  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (message || !folder) {
        setError(
          message ||
            t("projects.createError", "Projekt konnte nicht erstellt werden."),
        );
        return;
      }
        ...
        <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              placeholder={t(
                ...
                "z.B. API Gateway, Politik-Forschung...",
              )}
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-theme-bg-secondary/50 border border-theme-modal-border/50 opacity-60">
            ...
            <span className="text-xs text-theme-text-muted">
              {t(
                "projects.githubComingSoon",
                "GitHub-Klonen: Demnächst verfügbar",
              )}
            </span>
          </div>
