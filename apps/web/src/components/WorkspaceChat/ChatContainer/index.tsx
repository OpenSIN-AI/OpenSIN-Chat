...
export default function ChatContainer({
  ...
  const { runnerId: selectedCodeRunnerId } = useSelectedCodeRunner(
    workspace?.slug,
  );
...
function ChatContainerInner({
  ...
  const { document: parsedContext } = useDocument(workspace?.slug, threadSlug);
  ...
  return (
    ...
    >
      <div
        ...
        className="relative z-[2] flex h-[var(--content-height)] min-w-0 flex-1 overflow-hidden md:ml-0 md:my-[16px] md:mr-4"
      >
