...
const CURATED_FILES = [
  ...
  { src: "deployment/overview.md", dst: "deployment-overview.md" },
  { src: "deployment/docker.md", dst: "docker-deployment.md" },
  { src: "deployment/auto-deploy.md", dst: "auto-deploy.md" },
  { src: "deployment/vercel.md", dst: "vercel.md" },
  { src: "deployment/ssh-remote-tunnel.md", dst: "ssh-remote-tunnel.md" },
  { src: "deployment/supabase-self-hosted.md", dst: "supabase-self-hosted.md" },
