...
describe("EncryptionManager — additional edge cases", () => {
  const key = "additional-test-key-16ch"; // gitleaks:allow -- intentional fixture or published public key
  ...
  describe("constructor — ENV auto-generation", () => {
    ...
    it("reuses existing ENV values when present", () => {
      process.env.SIG_KEY = "env-key-12345678901234"; // gitleaks:allow -- intentional fixture or published public key
