...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "OpenSIN Chat peut fonctionner avec de nombreux fournisseurs LLM. Ce sera le service qui traitera vos discussions.",
    },
    userSetup: {
    ...
    data: {
      ...
      description:
        "Configurez comment OpenSIN Chat stocke et traite vos données.",
      settingsHint:
  ...
  general: {
    ...
    message: {
      ...
      body: "les avantages de OpenSIN Chat",
    },
    delete: {
  ...
  agent: {
      ...
      createFiles: {
        ...
        skills: {
          ...
          "read-pdf-file": {
            title: "Lire un PDF",
            description:
              "Extraire le contenu textuel d'un document PDF existant",
          },
        },
      },
      image_generation: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Bêta",
        description:
          "Permettez l'utilisation illimitée d'outils et réduisez la consommation de jetons jusqu'à 80 % par requête – OpenSIN Chat sélectionne automatiquement les compétences appropriées pour chaque requête.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "Clés API",
    description:
      "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance OpenSIN Chat.",
    ...
    modal: {
      ...
      helper:
        "Une fois créée, la clé API peut être utilisée pour accéder à cette instance OpenSIN Chat et la configurer de manière programmatique.",
      name: {
        label: "Nom",
  ...
  llm: {
    title: "Préférence LLM",
    description:
      "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon OpenSIN Chat ne fonctionnera pas correctement.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer OpenSIN Chat lors du traitement des fichiers multimédias.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que OpenSIN Chat peut utiliser pour traiter.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Voici les identifiants et les paramètres de fonctionnement de votre instance OpenSIN Chat. Il est important que ces clés soient actuelles et correctes.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Voici votre configuration pour la gestion des données et des fournisseurs tiers connectés avec OpenSIN Chat.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ces fichiers seront téléchargés sur cette instance OpenSIN Chat uniquement.",
    },
    pinning: {
      what_pinning: "Qu'est-ce que l'épinglage de documents ?",
      pin_explained_block1:
        "Lorsque vous épinglez un document, OpenSIN Chat injectera le contenu intégral du document dans votre fenêtre de prompt comme contexte préalable pour chaque interaction.",
    ...
    watching: {
      ...
      watch_explained_block1:
        "Lorsque vous surveillez un document, OpenSIN Chat re-synchronisera automatiquement le contenu du document depuis sa source de manière périodique.",
  ...
  chat_window: {
    ...
    attach_menu: {
      ...
      current_sources: "Sources actuelles",
      add_from_url: "Ajouter depuis une URL",
      loading: "Chargement...",
      no_sources: "Aucune source disponible",
      no_workspace:
        "Aucun espace de travail disponible. Envoyez d'abord un message pour en créer un.",
      add_success: "Source ajoutée à l'espace de travail",
      add_failed: "Impossible d'ajouter la source",
      url_hint:
        "Collez l'URL d'un site web ou d'une vidéo YouTube pour l'ajouter comme source.",
      url_submit: "Ajouter la source",
      url_submitting: "Ajout en cours...",
      url_success: "URL ajoutée comme source",
      url_failed: "Impossible d'ajouter l'URL",
    },
    document: "Document",
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mémoire",
        placeholder:
          "Par exemple, le nom de l'utilisateur est Joe, l'utilisateur travaille sur OpenSIN Chat, etc.",
        create: "Créer",
        save: "Enregistrer",
        cancel: "Annuler",
      },
  ...
  "main-page": {
    workspaceSources: {
      title: "Sources de l'espace de travail",
      add: "Ajouter des sources",
      empty:
        "Pas encore de sources.\nTéléchargez des documents ou ajoutez des URL pour donner plus de contexte au chat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Vous devez vous connecter à votre compte OpenSIN Chat pour publier sur le Community Hub.",
          button: "Se connecter",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protégez votre instance OpenSIN Chat avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
  ...
  telegram: {
    title: "Bot Telegram",
    description:
      "Connectez votre instance de OpenSIN Chat à Telegram afin de pouvoir communiquer avec vos espaces de travail depuis n'importe quel appareil.",
    setup: {
      step1: {
