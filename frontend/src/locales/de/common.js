...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description: "OpenSIN Chat ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet."
    },
    userSetup: {
    ...
    survey: {
      ...
      description: "Helfen Sie uns, OpenSIN Chat an Ihre Bedürfnisse anzupassen. (Optional)",
  ...
  providerSettings: {
    ...
    lemonade: {
      ...
      baseUrlTooltip2: "Sie müssen die Lemonade TCP-Unterstützung aktiviert haben, damit dies funktioniert.",
      learnMore: "Mehr erfahren",
      baseUrlPlaceholder: "http://localhost:13305",
      modelContextWindow: "Modell-Kontextfenster",
      modelContextWindowTooltip: "Die maximale Anzahl an Token, die für ein Modell-Kontextfenster verwendet werden können. Dies muss auf einen vom Modell unterstützten Wert gesetzt werden.",
      ...
      uninstallConfirm: "Sind Sie sicher, dass Sie dieses Modell deinstallieren möchten? Sie müssen es erneut herunterladen, um es zu verwenden.",
      downloadConfirm: "Sind Sie sicher, dass Sie dieses Modell herunterladen möchten? Es hat eine Größe von {{fileSize}} und der Download kann eine Weile dauern."
    },
    cometApi: {
      ...
      modelInputHelp: "Sie können die Modell-ID direkt eingeben oder aus Vorschlägen auswählen.",
      advancedSettings: "erweiterte Einstellungen",
      streamTimeout: "Stream-Timeout (ms)",
      timeoutDescription: "Timeout-Wert zwischen Token-Antworten zum automatischen Beenden des Streams."
    },
    genericOpenAi: {
      baseUrl: "Basis-URL",
    ...
    geminiEmbedding: {
      ...
      outputDimensionsTooltip: "Die Anzahl der Dimensionen, die die resultierenden Ausgabe-Embeddings haben sollten, wenn mehrere Dimensionen unterstützt werden.",
      outputDimensionsTooltip2: "Leer lassen, um die Standarddimensionen für das ausgewählte Modell zu verwenden.",
    ...
    groqAi: {
      ...
      modelSelection: "Chat-Modellauswahl",
      loadingModels: "-- verfügbare Modelle werden geladen --",
      enterApiKeyHint: "Geben Sie einen gültigen API-Schlüssel ein, um alle verfügbaren Modelle für Ihr Konto anzuzeigen.",
      availableModels: "Verfügbare Modelle",
      selectModelHint: "Wählen Sie das GroqAI-Modell, das Sie für Ihre Konversationen verwenden möchten."
    },
    moonshotAi: {
      apiKey: "API-Schlüssel",
    ...
    xAi: {
      ...
      enterApiKeyHint: "Geben Sie einen gültigen API-Schlüssel ein, um alle verfügbaren Modelle für Ihr Konto anzuzeigen.",
      availableModels: "Verfügbare Modelle",
      selectModelHint: "Wählen Sie das xAI-Modell, das Sie für Ihre Konversationen verwenden möchten."
    },
    zAi: {
      ...
      enterApiKeyHint: "Geben Sie einen gültigen API-Schlüssel ein, um alle verfügbaren Modelle für Ihr Konto anzuzeigen.",
      availableModels: "Verfügbare Modelle",
      selectModelHint: "Wählen Sie das Z.AI-Modell, das Sie für Ihre Konversationen verwenden möchten."
    },
    azureAiEmbedding: {
      ...
      embeddingDeploymentNamePlaceholder: "Azure OpenAI Embedding-Modell-Bereitstellungsname"
    },
    openAiEmbedding: {
      apiKey: "API-Schlüssel",
      apiKeyPlaceholder: "OpenAI API-Schlüssel",
  ...
  chat_window: {
    ...
    attach_menu: {
      ...
      no_workspace: "Kein Workspace verfügbar. Sende zuerst eine Nachricht, um einen Workspace zu erstellen.",
      add_success: "Quelle zum Workspace hinzugefügt",
      add_failed: "Quelle konnte nicht hinzugefügt werden",
      url_hint: "Füge die URL einer Webseite oder eines YouTube-Videos ein, um sie als Quelle hinzuzufügen.",
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Gedächtnis",
        placeholder: "z.B. Benutzername: Joe, Benutzer arbeitet an OpenSIN Chat, usw.",
        create: "Erstellen",
        save: "Speichern",
        cancel: "Abbrechen"
      }
  ...
  common: {
    ...
    docsNotFoundDesc: "Das angeforderte Dokument existiert nicht oder wurde verschoben.",
    ...
    docsLandingSubtitle: "Alles, was du zum Verstehen, Betreiben und Erweitern von OpenSIN Chat brauchst.",
  ...
  chat: {
    ...
    refusal: {
      ...
      placeholder: "Der Text, der im Abfragemodus zurückgegeben wird, wenn kein relevanter Kontext für eine Antwort gefunden wurde."
    },
    temperature: {
  ...
  agent: {
    ...
    skill: {
      ...
      image_generation: {
        ...
        description: "Erstellen Sie Bilder mit jeder OpenAI-kompatiblen Bildgenerierungs-API. Konfigurieren Sie den Endpunkt, den API-Schlüssel und das Modell unten.",
        base_url: {
          label: "Basis-URL",
          required: "(Pflichtfeld)",
          placeholder: "https://api.openai.com",
          help: "Basis-URL für die OpenAI-kompatible API (z. B. {{example}})",
          invalid: "Bitte geben Sie eine gültige http://- oder https://-URL ein."
        },
        api_key: {
          label: "API-Schlüssel",
    ...
    mcp: {
      ...
      "refresh-confirm": "Möchten Sie die Liste der MCP-Server wirklich aktualisieren? Dies startet alle MCP-Server neu und lädt ihre Tools neu.",
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description: "Ermöglichen Sie die uneingeschränkte Nutzung von Werkzeugen und reduzieren Sie die Token-Nutzung pro Anfrage um bis zu 80 % – OpenSIN Chat wählt automatisch die passenden Fähigkeiten für jede Anfrage aus.",
        "max-tools": {
          title: "Max Tools",
  ...
  agentBuilder: {
    summarizeDescription: "Wenn aktiviert, werden lange Webseiteninhalte automatisch zusammengefasst, um Token-Verbrauch zu reduzieren.",
    summarizeNote: "Hinweis: Dies kann die Datenqualität beeinflussen und spezifische Details des Originalinhalts entfernen.",
    finishNodeDescription: "Dies ist das Ende Ihres Agenten-Flows. Alle oben stehenden Schritte werden nacheinander ausgeführt.",
    fileNode: {
      operation: "Operation",
    ...
    flowInfoNode: {
      flowName: "Flow-Name",
      flowNameDescription: "Es ist wichtig, Ihrem Flow einen Namen zu geben, den ein LLM leicht verstehen kann.",
      flowNameExamples: '"SendMessageToDiscord", "CheckStockPrice", "CheckWeather"',
      enterFlowName: "Flow-Namen eingeben",
      description: "Beschreibung",
      descriptionExplanation: "Es ist ebenso wichtig, Ihrem Flow eine Beschreibung zu geben, die ein LLM leicht verstehen kann. Geben Sie den Zweck des Flows, den Kontext, in dem er verwendet wird, und alle anderen relevanten Informationen an.",
  ...
  preview: {
    ...
    empty: "Kein Inhalt zur Vorschau. Generiere einen Bericht oder ein Dokument, um es hier anzuzeigen.",
    title: "Vorschau",
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Individualisieren Sie Ihre OpenSIN Chat-Instanz durch eigenes Branding."
    },
    chat: {
      title: "Chat",
  ...
  api: {
    title: "API-Schlüssel",
    description: "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese OpenSIN Chat-Instanz zuzugreifen und sie zu verwalten.",
    ...
    modal: {
      ...
      helper: "Nach der Erstellung kann der API-Schlüssel verwendet werden, um programmgesteuert auf diese OpenSIN Chat-Instanz zuzugreifen und sie zu konfigurieren.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM-Präferenz",
    description: "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird OpenSIN Chat nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start": "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann OpenSIN Chat bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
  ...
  embedding: {
    ...
    "desc-end": "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das OpenSIN Chat zur Verarbeitung verwenden kann.",
    provider: {
  ...
  vector: {
    ...
    description: "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer OpenSIN Chat-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  privacy: {
    ...
    description: "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und OpenSIN Chat Ihre Daten behandeln.",
  ...
  connectors: {
    ...
    github: {
      ...
      fetching_files: "Alle Dateien des Repositories werden abgerufen – dies kann einen Moment dauern.",
      files_collected: "{{files}} {{filePlural}} gesammelt aus {{author}}/{{repo}}:{{branch}}. Ausgabeordner ist {{destination}}.",
    ...
    upload: {
      ...
      "privacy-notice": "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser OpenSIN Chat-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt."
    },
    pinning: {
  ...
  communityHub: {
    title: "Community Hub",
    trendingDescription: "Teilen und kooperieren Sie mit der OpenSIN Chat Community.",
    importDescription: "Importieren Sie Elemente aus dem OpenSIN Chat Community Hub, um Ihre Instanz mit Community-erstellten Prompts, Fähigkeiten und Befehlen zu erweitern.",
    auth: {
      ...
      userItems: {
        ...
        createdByMeDescription: "Elemente, die Sie erstellt und öffentlich im OpenSIN Chat Community Hub geteilt haben.",
        noItemsCreated: "Sie haben noch keine Elemente erstellt.",
        itemsByTeam: "Elemente nach Team",
        itemsByTeamDescription: "Öffentliche und private Elemente, die mit Teams geteilt wurden, denen Sie angehören.",
    ...
    import: {
      ...
      unsupported: {
        ...
        description: "Wir haben ein Element im Community Hub gefunden, aber wir wissen nicht, was es ist, oder es wird noch nicht für den Import in OpenSIN Chat unterstützt.",
        itemId: "Die Element-ID lautet:",
        itemType: "Der Elementtyp lautet:",
        contactSupport: "Bitte kontaktieren Sie den Support per E-Mail, wenn Sie Hilfe beim Import dieses Elements benötigen.",
  ...
  community_hub: {
    publish: {
      ...
      agent_flow: {
        ...
        flow_steps_description: "Die Schritte, die der Agent ausführt, wenn der Flow ausgelöst wird.",
      ...
      generic: {
        unauthenticated: {
          ...
          description: "Sie müssen sich vor der Veröffentlichung von Inhalten über den OpenSIN Chat Community Hub authentifizieren.",
  ...
  security: {
    ...
    password: {
      ...
      description: "Schützen Sie Ihre OpenSIN Chat-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
  ...
  webSearch: {
    ...
    getFreeApiKeySearchApi: "Sie können einen kostenlosen API-Schlüssel erhalten",
    ...
    getBingWebSearchSubscription: "Sie können einen Bing Web Search API-Abonnement-Schlüssel erhalten",
    ...
    bingSetupStep2: "Erstellen Sie ein neues Azure-Konto oder melden Sie sich mit einem bestehenden an.",
    bingSetupStep3: 'Navigieren Sie zum Abschnitt "Ressource erstellen" und suchen Sie nach "Grounding with Bing Search".',
    bingSetupStep4: 'Wählen Sie die Ressource "Grounding with Bing Search" und erstellen Sie ein neues Abonnement.',
    bingSetupStep5: "Wählen Sie den Tarif, der Ihren Anforderungen entspricht.",
    bingSetupStep6: "Erhalten Sie den API-Schlüssel für Ihr Grounding with Bing Search-Abonnement.",
    ...
    duckduckgoNoConfig: "DuckDuckGo ist ohne weitere Konfiguration einsatzbereit.",
    fromExa: "von Exa.",
    exaApiKey: "Exa API-Schlüssel",
    fromPerplexity: "von Perplexity.",
    perplexityApiKey: "Perplexity API-Schlüssel",
    vaneNoConfig: "Vane läuft als lokaler Sidecar-Container und benötigt keinen API-Schlüssel. Der Endpunkt wird über die Umgebungsvariable VANE_API_URL konfiguriert (Standard: http://vane:3000). Schließe zuerst die einmalige Modell-Einrichtung in der Vane-Web-UI ab."
  },
  ollama: {
    advancedSettings: "erweiterte Einstellungen",
    ...
    keepAliveTooltip: "Wählen Sie, wie lange Ollama Ihr Modell im Speicher behalten soll, bevor es entladen wird.",
    ...
    contextWindowTooltip: "Geben Sie die maximale Anzahl von Tokens an, die für das Modell-Kontextfenster verwendet werden können.",
    contextWindowTooltip2: "Wenn Sie dieses Feld leer lassen, wird das Kontextfenster-Limit automatisch vom Modell erkannt und auf alle Chats angewendet. Wenn die automatische Erkennung fehlschlägt, wird ein Fallback-Kontextfenster-Limit von 4096 verwendet.",
    contextWindowTooltipImportant: "Wichtig",
    contextWindowTooltipImportantText: "Einige Modelle haben sehr große Kontextfenster. Die Verwendung des vollen Kontextfenster-Limits kann den Speicherverbrauch Ihres Systems drastisch erhöhen. Aus diesem Grund begrenzen wir das Kontextfenster-Limit automatisch auf 16.384 Tokens, wenn das Modell mehr unterstützt und kein Wert angegeben ist.",
    contextWindowTooltipFallback: "Wenn ein ungültiger Wert eingegeben wird, kümmert sich OpenSIN Chat darum, damit Chats nicht fehlschlagen.",
    ...
    authTokenTooltip1End: "Auth-Token für die Interaktion mit Ihrem Ollama-Server ein.",
    authTokenTooltip2: "Verwendet",
    authTokenTooltip2b: "nur",
    authTokenTooltip2End: "wenn Ollama hinter einem Authentifizierungsserver läuft.",
    authTokenPlaceholder: "Ollama Auth-Token",
    modelLabel: "Ollama Modell",
    loadingModels: "-- verfügbare Modelle werden geladen --",
    enterUrlFirst: "Geben Sie zuerst die Ollama-URL ein",
    selectModelHelp: "Wählen Sie das Ollama-Modell aus, das Sie verwenden möchten. Modelle werden nach Eingabe einer gültigen Ollama-URL geladen.",
    yourLoadedModels: "Ihre geladenen Modelle",
    chooseModelHelp: "Wählen Sie das Ollama-Modell aus, das Sie für Ihre Konversationen verwenden möchten.",
  ...
  ollamaEmbedding: {
    ...
    maxChunkLengthTooltip: "Maximale Länge von Text-Chunks in Zeichen für das Embedding.",
    ...
    batchSizeTooltip: "Anzahl der Text-Chunks, die parallel eingebettet werden. Höhere Werte verbessern die Geschwindigkeit, verbrauchen aber mehr Speicher. Standard ist 1.",
    batchSizePlaceholder: "1",
    batchSizeHelp: "Erhöhen Sie diesen Wert, um mehrere Chunks gleichzeitig für schnelleres Embedding zu verarbeiten.",
    ...
    authTokenHelp1End: "Auth-Token für die Interaktion mit Ihrem Ollama-Server ein.",
    authTokenHelp2: "Verwendet",
    authTokenHelp2b: "nur",
    authTokenHelp2End: "wenn Ollama hinter einem Authentifizierungsserver läuft.",
    modelLabel: "Ollama Embedding-Modell",
    loadingModels: "--verfügbare Modelle werden geladen--",
    enterUrlFirst: "Geben Sie zuerst die Ollama-URL ein",
    selectModelHelp: "Wählen Sie das Ollama-Modell für Embeddings aus. Modelle werden nach Eingabe einer gültigen Ollama-URL geladen.",
    yourLoadedModels: "Ihre geladenen Modelle",
    chooseModelHelp: "Wählen Sie das Ollama-Modell aus, das Sie zum Erzeugen von Embeddings verwenden möchten."
  },
  ...
  localAiEmbedding: {
    ...
    outputDimensionsTooltip2: "Leer lassen, um den Standard des Modells zu verwenden.",
  ...
  lmStudioEmbedding: {
    ...
    modelErrorTooltip: "Modelle konnten nicht vom LM Studio-Server geladen werden.",
    loadingModels: "-- verfügbare Modelle werden geladen --",
    noModelsFound: "Keine Modelle gefunden",
    enterUrlFirst: "Geben Sie zuerst die LM Studio-URL ein",
    yourLoadedModels: "Ihre geladenen Modelle",
    modelDescription: "Wählen Sie das Modell aus, das Sie für Embeddings verwenden möchten.",
    maxChunkLengthLabel: "Maximale Embedding-Chunk-Länge",
    maxChunkLengthTooltip: "Maximale Länge von Text-Chunks in Zeichen für das Embedding.",
    ...
    authTokenTooltipBearer: "Bearer",
    authTokenTooltipPart2: "Auth-Token für die Interaktion mit Ihrem LM Studio-Server ein.",
    authTokenTooltipPart3: "Wird nur verwendet, wenn LM Studio hinter einem Authentifizierungsserver läuft.",
  ...
  lemonadeEmbedding: {
    ...
    yourLoadedModels: "Ihre geladenen Modelle",
    selectModelHelp: "Wählen Sie das Lemonade-Modell aus, das Sie für Embeddings verwenden möchten.",
    maxChunkLengthLabel: "Maximale Embedding-Chunk-Länge",
    maxChunkLengthTooltip: "Maximale Länge von Text-Chunks in Zeichen für das Embedding.",
    maxChunkLengthPlaceholder: "8192",
    apiKeyLabel: "API-Schlüssel",
    ...
    baseUrlTooltip: "Geben Sie die URL ein, unter der der Lemonade-Server läuft.",
    baseUrlPlaceholder: "http://localhost:13305",
    autoDetect: "Automatisch erkennen",
  ...
  agentLLMItem: {
    ...
    setupDescription: "Um {{name}} als Agent-LLM dieses Arbeitsbereichs zu verwenden, müssen Sie es zuerst einrichten.",
    cancel: "Abbrechen",
  ...
  pdfAnalysis: {
    crossCheck: {
      ...
      claimsPlaceholder: "z.B. Das Förderprogramm endet am 31.12.2026\nDie Zuständigkeit liegt beim Landesamt",
      factIdsLabel: "Fakt-IDs aus dem Fakten-Speicher (kommasepariert, optional)",
      ...
      sourceValuePdfPlaceholder: "/pfad/zur/datei.pdf (freigegebenes Verzeichnis)",
      ...
      deepWebLabel: "Deep-Web-Recherche: Agenten recherchieren zusätzlich autonom im Web",
      submitError1: "Mindestens eine Behauptung oder Fakt-ID angeben.",
      submitError2: "Mindestens eine Vergleichsquelle ODER Deep-Web-Recherche aktivieren.",
      submitBusy: "Wird gestartet…",
      submitIdle: "Verifikation starten",
      sourcesCount: "{{count}} Vergleichsquellen",
  ...
  sqlConnection: {
    ...
    descriptionEdit: "Aktualisieren Sie die Verbindungsinformationen für Ihre Datenbank unten.",
    descriptionNew: "Fügen Sie die Verbindungsinformationen für Ihre Datenbank unten hinzu und sie wird für zukünftige SQL-Agent-Aufrufe verfügbar sein.",
    warningLabel: "WARNUNG:",
    warningText: "Der SQL-Agent wurde",
    warningInstructed: "angewiesen",
    warningToOnlyPerform: "nur nicht-modifizierende Abfragen durchzuführen. Dies",
    warningDoesNotPrevent: "verhindert",
    warningDoesNotPrevent2: "nicht, dass eine Halluzination trotzdem Daten löscht. Stellen Sie nur eine Verbindung mit einem Benutzer her, der",
    ...
    connectionNamePlaceholder: "ein eindeutiger Name zur Identifizierung dieser SQL-Verbindung",
    ...
    duplicateError: 'Eine Verbindung mit dem Namen "{{name}}" existiert bereits. Bitte wählen Sie einen anderen Namen.',
    fillAllFields: "Bitte füllen Sie alle Felder oben aus.",
    validationFailed: "Verbindung konnte nicht validiert werden. Bitte überprüfen Sie Ihre Verbindungsdaten.",
    connectionFailed: "Datenbankverbindung konnte nicht hergestellt werden. Bitte überprüfen Sie Ihre Verbindungsdaten."
  },
  apiCallNode: {
    url: "URL",
  ...
  drupalWiki: {
    ...
    baseUrlDescription: "Dies ist die Basis-URL Ihrer <a>Drupal Wiki</a>-Seite.",
    baseUrlPlaceholder: "z.B. https://mywiki.drupal-wiki.net, https://drupalwiki.myfirma.tld, usw...",
    spaceIdsLabel: "Drupal Wiki Space-IDs",
    spaceIdsDescription: "Kommagetrennte Space-IDs, die Sie extrahieren möchten. Siehe <a>Handbuch</a> zum Abrufen der Space-IDs. Stellen Sie sicher, dass Ihr 'API-Token-Benutzer' Zugriff auf diese Spaces hat.",
    spaceIdsPlaceholder: "z.B. 12,34,69",
    apiTokenLabel: "Drupal Wiki API-Token",
    apiTokenTooltip: "Sie müssen einen API-Token zur Authentifizierung bereitstellen. Siehe das Drupal Wiki <a>Handbuch</a> zum Generieren eines API-Tokens für Ihren Benutzer.",
    ...
    collectingDescription: "Nach Abschluss stehen alle Seiten zur Einbettung in Workspaces zur Verfügung.",
    toastFetching: "Alle Seiten für die angegebenen Drupal Wiki Spaces werden abgerufen - dies kann eine Weile dauern.",
    toastSuccess: "Seiten von Drupal Wiki Spaces {{spaceIds}} gesammelt. Ausgabeordner ist {{destination}}."
  },
  fileUploadWarning: {
    ...
    description: "Ihr Workspace verwendet {{tokenCount}} von {{maxTokens}} verfügbaren Token. Wir empfehlen, die Nutzung unter {{limit}}% zu halten, um die beste Chat-Erfahrung zu gewährleisten. Das Hinzufügen von {{fileCount}} weiteren {{fileWord}} würde dieses Limit überschreiten. <a>Mehr über Kontextfenster erfahren →</a>",
  ...
  providerKeyStatus: {
    section: {
      ...
      subtitle: "Fallback aktiv = Provider läuft mit sicherem Platzhalter-Key (kein Crash, aber kein echter Key gesetzt)."
    },
    refresh: {
    ...
    storagePath: {
      problem: "Speicherpfad-Problem erkannt: {{path}} (existiert: {{exists}}, beschreibbar: {{writable}}, Hotdir: {{hotdir}}).",
      ok: "ok",
      missing: "fehlt"
    },
  ...
  pgVector: {
    connectionString: {
      ...
      tooltip: {
        intro: "Dies ist die Verbindungszeichenfolge für die Postgres-Datenbank im Format",
        permissions: "Der Benutzer für die Datenbank muss die folgenden Berechtigungen haben:",
        perm1: "Lesezugriff auf die Datenbank",
        perm2: "Lesezugriff auf das Datenbankschema",
        perm3: "Erstellungszugriff auf die Datenbank",
        extension: "Sie müssen die pgvector-Erweiterung in der Datenbank installiert haben."
      }
    },
    tableName: {
      ...
      tooltip: {
        intro: "Dies ist der Name der Tabelle in der Postgres-Datenbank, in der die Vektoren gespeichert werden.",
        default: "Standardmäßig lautet der Tabellenname",
        warning: "Diese Tabelle darf noch nicht in der Datenbank vorhanden sein - sie wird automatisch erstellt."
      }
    }
  },
  defaultSystemPrompt: {
    title: "Default System Prompt",
    subtitle: "Dies ist der Standard-System-Prompt, der für neue Workspaces verwendet wird.",
    label: "System Prompt",
    description: {
      part1: "Ein System-Prompt enthält Anweisungen, die die Antworten und das Verhalten der KI formen. Dieser Prompt wird automatisch auf alle neu erstellten Workspaces angewendet. Um den System-Prompt eines",
      ...
      part3: ". Um den System-Prompt auf unsere sinnvolle Standardeinstellung zurückzusetzen, lassen Sie dieses Feld leer und speichern Sie die Änderungen."
    },
    variables: {
      intro: "Sie können",
    ...
    placeholder: "Sie sind ein KI-Assistent, der Fragen beantworten und bei Aufgaben helfen kann.",
    toast: {
      success: "Default System Prompt erfolgreich aktualisiert.",
      failure: "Fehler beim Aktualisieren des Default System Prompts: {{message}}"
    }
  },
  newUserModal: {
    ...
    error: "Fehler: {{error}}",
    afterCreate: "Nach dem Erstellen eines Benutzers muss sich dieser mit seinem initialen Login anmelden, um Zugriff zu erhalten.",
  ...
  liteLLM: {
    ...
    modelSelection: {
      ...
      yourLoadedModels: "Ihre geladenen Modelle",
      tooltip: {
        intro: "Stellen Sie sicher, dass Sie ein gültiges Embedding-Modell auswählen. Chat-Modelle sind keine Embedding-Modelle. Siehe",
  ...
  kokoro: {
    ...
    voiceModel: {
      ...
      unreachable: "Der Kokoro-Server konnte nicht erreicht werden, um Stimmen zu laden. Geben Sie eine Stimmen-ID manuell ein."
    }
  },
  webScrapingNode: {
    ...
    querySelectorHelp: "Geben Sie einen gültigen CSS-Selector ein, um den Inhalt der Seite zu scrapen.",
  ...
  agentSkill: {
    ...
    learnMore: "Mehr erfahren →",
    description: {
      part1: "Agent-Skills schalten neue Fähigkeiten für Ihren OpenSIN Chat-Workspace frei via",
  ...
  admin: {
    ...
    systemPromptVariables: {
      ...
      page: {
        ...
        deleteConfirm: 'Möchten Sie die Variable "{{key}}" wirklich löschen?\nDiese Aktion ist unwiderruflich.',
    ...
    workspacesPage: {
      ...
      description: "Dies sind alle Workspaces, die auf dieser Instanz existieren. Das Entfernen eines Workspaces löscht alle zugehörigen Chats und Einstellungen.",
    ...
    newWorkspaceModal: {
      ...
      placeholder: "Mein Workspace",
      error: "Fehler: {{error}}",
      adminOnlyHint: "Nach dem Erstellen dieses Workspaces können nur Administratoren ihn sehen. Sie können nach der Erstellung Benutzer hinzufügen.",
      cancel: "Abbrechen",
  ...
  invite: {
    newUser: {
      ...
      error: "Fehler: {{error}}",
      afterCreateHint: "Nach der Erstellung Ihres Kontos können Sie sich mit diesen Anmeldedaten anmelden und Workspaces nutzen.",
  ...
  audioPreference: {
    stt: {
      ...
      description: "Hier können Sie festlegen, welche Spracherkennungs- und Sprachsynthese-Anbieter Sie in Ihrer OpenSIN Chat-Erfahrung nutzen möchten. Standardmäßig verwenden wir die im Browser integrierte Unterstützung für diese Dienste, aber Sie können auch andere verwenden.",
      ...
      genericOpenaiDesc: "Verbinden Sie sich mit einem OpenAI-kompatiblen STT-Dienst über eine benutzerdefinierte Konfiguration."
    },
    tts: {
      title: "Text-zu-Sprache-Einstellung",
      description: "Hier können Sie festlegen, welche Text-zu-Sprache-Anbieter Sie in Ihrer OpenSIN Chat-Erfahrung nutzen möchten. Standardmäßig verwenden wir die im Browser integrierte Unterstützung für diese Dienste, aber Sie können auch andere verwenden.",
      ...
      kokoro: "Kokoro",
      kokoroDesc: "Verbinden Sie sich mit einem selbstgehosteten kokoro-fastapi-Server für hochwertige Open-Source-Stimmen.",
      openaiCompatible: "OpenAI-kompatibel",
      openaiCompatibleDesc: "Verbinden Sie sich mit einem OpenAI-kompatiblen TTS-Dienst, der lokal oder remote ausgeführt wird.",
      nvidiaNim: "NVIDIA NIM",
      nvidiaNimDesc: "Verwenden Sie NVIDIA NIMs gehostete Text-zu-Sprache-API mit hochwertigen Stimmen."
    }
  },
  embedChats: {
    chatRow: {
  ...
  mobileConnections: {
    ...
    description: "Dies sind die Geräte, die mit Ihrer Desktop-Anwendung verbunden sind, um Chats, Workspaces und mehr zu synchronisieren.",
    ...
    connectionModal: {
      ...
      description: "OpenSIN Chat für Mobilgeräte ermöglicht es Ihnen, sich mit den Chats, Threads, Tools und Dokumenten Ihres Workspaces zu verbinden, um sie unterwegs zu nutzen.\n\nFühren Sie lokale Modelle auf Ihrem Telefon privat aus oder leiten Sie Chats direkt an diese Instanz weiter.",
      scanHint: "Scannen Sie den QR-Code mit der OpenSIN Chat Mobile-App, um die Live-Synchronisierung Ihrer Workspaces, Chats, Threads und Dokumente zu aktivieren.",
      learnMore: "Mehr erfahren"
    }
  },
  attachments: {
    ...
    willBeAttachedPrompt: "{{name}} wird an diesen Prompt angehängt. Es wird nicht dauerhaft in den Workspace eingebettet.",
    wasEmbedded: "{{name}} wurde hochgeladen und in diesen Workspace eingebettet. Es ist jetzt für RAG-Chat verfügbar.",
    willBeUsedAsContext: "{{name}} wird nur als Kontext für diesen Chat verwendet.",
    previewOf: "Vorschau von {{name}}"
  },
  setupProvider: {
    saveFailed: "Fehler beim Speichern der {{name}} Einstellungen: {{error}}",
    title: "{{name}} Einstellungen",
    description: "Um {{name}} als LLM dieses Workspace zu nutzen, müssen Sie es zuerst einrichten.",
    cancel: "Abbrechen",
  ...
  inviteRow: {
    deactivateConfirm: "Möchten Sie diese Einladung wirklich deaktivieren?\nDanach kann sie nicht mehr verwendet werden.\n\nDiese Aktion ist unwiderruflich.",
    disabled: "Deaktiviert",
  ...
  codeSnippetModal: {
    ...
    scriptTagDescription: "Lassen Sie Ihren Workspace-Chat-Einbettung wie einen Helpdesk-Chat in der Ecke Ihrer Website funktionieren.",
  ...
  importedSkillConfig: {
    ...
    confirmDeleteSkill: "Sind Sie sicher, dass Sie diese Fähigkeit löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
  ...
  pullAndReview: {
    ...
    error: "Beim Abrufen des Elements ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.",
    tryAnotherItem: "Anderes Element versuchen"
  },
  customSiteSettings: {
    updateSuccess: "Seiteneinstellungen aktualisiert! Sie werden beim Neuladen der Seite wirksam.",
  ...
  agentConfig: {
    ...
    configureDescription: "Passen Sie die Fähigkeiten des Standard-Agenten an, indem Sie bestimmte Skills aktivieren oder deaktivieren. Diese Einstellungen gelten für alle Arbeitsbereiche.",
  ...
  settingsSidebar: {
    ...
    experimentalFeaturesUnlocked: "Experimentelle Funktionsvorschau freigeschaltet!"
  },
  ...
  vectorSearch: {
    ...
    defaultDescription: "Dies bietet die schnellste Leistung, kann jedoch zu weniger relevanten Ergebnissen und damit zu Modell-Halluzinationen führen.",
    accuracyOptimizedDescription: "LLM-Antworten können länger dauern, sind aber genauer und relevanter."
  },
  uploadProgress: {
