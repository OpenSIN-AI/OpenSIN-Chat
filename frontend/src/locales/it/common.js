...
const TRANSLATIONS = {
  onboarding: {
    survey: {
      ...
      useCase: "Quali utilizzi intende fare con OpenAfD Chat?",
      useCaseWork: "Per lavoro",
      useCasePersonal: "Per uso personale",
      useCaseOther: "Altro",
      comment: "Come ha saputo di OpenAfD Chat?",
      commentPlaceholder:
      ...
      title: "Benvenuti in OpenAfD Chat",
      description:
        "Aiutaci a sviluppare OpenAfD Chat in base alle tue esigenze. Facoltativo.",
    },
    home: {
      getStarted: "Inizia",
      welcome: "Benvenuti",
    ...
    llm: {
      ...
      description:
        "OpenAfD Chat può collaborare con numerosi fornitori di modelli linguistici. Questo sarà il servizio che gestirà le conversazioni.",
    },
    userSetup: {
  ...
  general: {
    ...
    message: {
      ...
      save: "Salva messaggi",
      heading: "Spiegami",
      body: "i vantaggi di OpenAfD Chat",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Abilita l'uso illimitato degli strumenti e riduci l'utilizzo dei token fino all'80% per ogni query — OpenAfD Chat seleziona automaticamente le competenze più appropriate per ogni richiesta.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "Chiavi API",
    description:
      "Le chiavi API consentono al titolare di accedere e gestire in modo programmatico questa istanza OpenAfD Chat.",
    ...
    modal: {
      ...
      helper:
        "Una volta creata, la chiave API può essere usata per accedere e configurare questa istanza OpenAfD Chat in modo programmatico.",
      name: {
        label: "Nome",
  ...
  llm: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il tuo provider di chat e embedding LLM preferito. È importante che queste chiavi siano aggiornate e corrette, altrimenti OpenAfD Chat non funzionerà correttamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilizzo del modello whisper locale su macchine con RAM o CPU limitate può bloccare OpenAfD Chat durante l'elaborazione di file multimediali.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding è il processo di trasformazione del testo in vettori. Queste credenziali sono necessarie per trasformare i file e i prompt in un formato che OpenAfD Chat può utilizzare per l'elaborazione.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il funzionamento della tua istanza OpenAfD Chat. È importante che queste chiavi siano aggiornate e corrette.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Questa è la tua configurazione per il modo in cui i provider terzi connessi e OpenAfD Chat gestiscono i tuoi dati.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Questi file verranno caricati nel processore di documenti in esecuzione su questa istanza di OpenAfD Chat. Questi file non vengono inviati o condivisi con terzi.",
    },
    pinning: {
      what_pinning: 'Cos\'è il "pinning" di un documento?',
      pin_explained_block1:
        'Quando si "fissa" un documento in OpenAfD Chat, caricheremo l\'intero contenuto del documento nella finestra di prompt per il tuo modello linguistico, in modo che possa comprenderlo appieno.',
      ...
      pin_explained_block3:
        'Se non ottenete le risposte desiderate da OpenAfD Chat per impostazione predefinita, allora l\'utilizzo del "pinning" è un ottimo modo per ottenere risposte di qualità superiore in pochi clic.',
      accept: "Ok, ho capito.",
    },
    watching: {
      what_watching: "Cosa si ottiene guardando un documentario?",
      watch_explained_block1:
        "Quando visualizzi un documento in OpenAfD Chat, il sistema <i>sincronizzerà automaticamente</i> il contenuto del documento dalla sua fonte originale a intervalli regolari. Ciò aggiornerà automaticamente il contenuto in tutti gli spazi di lavoro in cui questo file è gestito.",
  ...
  chat_window: {
    ...
    attach_menu: {
      ...
      current_sources: "Fonti attuali",
      add_from_url: "Aggiungi da URL",
      loading: "Caricamento...",
      no_sources: "Nessuna fonte disponibile",
      no_workspace:
        "Nessuna area di lavoro disponibile. Invia prima un messaggio per crearne una.",
      add_success: "Fonte aggiunta all'area di lavoro",
      add_failed: "Impossibile aggiungere la fonte",
      url_hint:
        "Incolla l'URL di un sito web o di un video YouTube per aggiungerlo come fonte.",
      url_submit: "Aggiungi fonte",
      url_submitting: "Aggiunta in corso...",
      url_success: "URL aggiunto come fonte",
      url_failed: "Impossibile aggiungere l'URL",
    },
    document: "Documento",
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memoria",
        placeholder:
          "ad esempio, il nome dell'utente è Joe, l'utente lavora su OpenAfD Chat, ecc.",
        create: "Creare",
        save: "Salva",
        cancel: "Annulla",
      },
  ...
  customization: {
    interface: {
      ...
      description:
        "Configura le tue preferenze dell'interfaccia utente per OpenAfD Chat.",
    },
    branding: {
      title: "Branding e personalizzazione",
      description:
        "Personalizza la tua istanza di OpenAfD Chat con il tuo marchio.",
    },
    chat: {
      title: "Chat",
      description: "Configura le tue preferenze di chat per OpenAfD Chat.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Seleziona la lingua preferita per visualizzare l'interfaccia utente di OpenAfD Chat – quando sono disponibili le traduzioni.",
      },
      logo: {
  ...
  "main-page": {
    ...
    workspaceSources: {
      ...
      add: "Aggiungi fonti",
      empty:
        "Nessuna fonte ancora.\nCarica documenti o aggiungi URL per dare più contesto alla chat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "È necessario autenticarsi tramite il Community Hub di OpenAfD Chat prima di pubblicare contenuti.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Proteggi la tua istanza OpenAfD Chat con una password. Se la dimentichi, non esiste un metodo di recupero, quindi assicurati di salvare questa password.",
  ...
  telegram: {
    ...
    description:
      "Collega la tua istanza di OpenAfD Chat a Telegram in modo da poter chattare con i tuoi spazi di lavoro da qualsiasi dispositivo.",
    setup: {
      step1: {
