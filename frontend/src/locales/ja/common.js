...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLMの設定",
      description:
        "OpenAfD Chatは多くのLLMプロバイダーと連携できます。これがチャットを処理するサービスになります。",
    },
    userSetup: {
      title: "ユーザー設定",
    ...
    survey: {
      title: "OpenAfD Chatへようこそ",
      description:
        "OpenAfD Chatをあなたのニーズに合わせて構築するためにご協力ください。任意です。",
      email: "メールアドレスは何ですか？",
      useCase: "OpenAfD Chatを何に使用しますか？",
      useCaseWork: "仕事用",
      useCasePersonal: "個人用",
      useCaseOther: "その他",
      comment: "OpenAfD Chatをどのように知りましたか？",
      commentPlaceholder:
  ...
  agent: {
    ...
    skill: {
      ...
      gmail: {
        ...
        skills: {
          ...
          getInbox: {
            title: "インボックスを開く",
            description: "Gmail から受信したメールを効���的に取得する方法",
          },
        },
      },
      outlook: {
      ...
      googleCalendar: {
        ...
        description:
          "エージェントがGoogleカレンダーと連携できるようにする - カレンダーの表示、イベントの取得、イベントの作成と更新、およびRSVPの管理��可能にする。詳細については、ドキュメントを参照してください。",
        multiUserWarning:
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "ベータ版",
        description:
          "クエリごとに、無制限のツールを使用し、トークン使用量を最大80%削減できます。OpenAfD Chatは、各プロンプトに対して最適なスキルを自動的に選択します。",
        "max-tools": {
          title: "マックスツールズ",
          description:
  ...
  api: {
    title: "APIキー",
    description:
      "APIキーにより、プログラム経由でこのOpenAfD Chatインスタンスにアクセスおよび管理できます。",
    link: "APIドキュメントを読む",
    ...
    modal: {
      ...
      create: "APIキーを作成",
      helper:
        "作成したAPIキーは、このOpenAfD Chatインスタンスにプログラムからアクセスして設定するために使用できます。",
      name: {
        label: "名前",
        placeholder: "本番環境の統合",
  ...
  llm: {
    title: "LLMの設定",
    description:
      "これは、お好みのLLMチャットおよび埋め込みプロバイダー用の認証情報と設定です。これらのキーが最新かつ正確でない場合、OpenAfD Chatは正しく動作しません。",
    provider: "LLMプロバイダー",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    "warn-start":
      "RAMやCPUが限られたマシンでローカルのWhisperモデルを使用すると、メディアファイルの処理中にOpenAfD Chatが停止する可能性があります。",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "埋め込みとは、テキストをベクトルに変換するプロセスです。これらの認証情報は、ファイルやプロンプトをOpenAfD Chatが処理できるフォーマットに変換するために必要です。",
    provider: {
      title: "埋め込みプロバイダー",
    },
  },
  ...
  vector: {
    title: "ベクターデータベース設定",
    description:
      "これは、OpenAfD Chatインスタンスの動作方法用の認証情報と設定です。これらのキーが最新で正確であることが重要です。",
    provider: {
  ...
  privacy: {
    title: "プライバシーとデータ処理",
    description:
      "これは、接続されているサードパーティプロバイダーとOpenAfD Chatがデータをどのように処理するかの設定です。",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "これらのファイルは、このOpenAfD Chatインスタンス上のドキュメント処理機能にアップロードされます。第三者に送信・共有されることはありません。",
    },
    pinning: {
      what_pinning: "ドキュメントのピン留めとは？",
      pin_explained_block1:
        "OpenAfD Chatでドキュメントを<b>ピン留め</b>すると、その内容全体がプロンプトウィンドウに挿入され、LLMがしっかり理解できるようになります。",
    ...
    watching: {
      ...
      watch_explained_block1:
        "OpenAfD Chatでドキュメントを<b>ウォッチ</b>すると、元のソースから定期的に内容が<i>自動的に</i>同期されます。管理しているすべてのワークスペースで内容が自動更新されます。",
  ...
  chat_window: {
    ...
    submit: "送信",
    edit_info_user:
      "「送信」はAIの応答を再生成します。「保存」は、あなたのメッセージのみを更��します。",
    ...
    attach_menu: {
      add_files: "ファイルを追加",
      current_sources: "現在のソース",
      add_from_url: "URLから追加",
      loading: "読み込み中...",
      no_sources: "利用可能なソースがありません",
      no_workspace:
        "利用可能なワークスペースがありません。まずメッセージを送信してワークスペースを作成してください。",
      add_success: "ソースをワークスペースに追加しました",
      add_failed: "ソースを追加できませんでした",
      url_hint:
        "ウェブサイトまたはYouTubeビデオのURLを貼り付けてソースとして追加してください。",
      url_submit: "ソースを追加",
      url_submitting: "追加中...",
      url_success: "URLをソースとして追加しました",
      url_failed: "URLを追加できませんでした",
    },
    document: "文書",
    similarity_match: "試合",
    ...
    memories: {
      title: "思い出",
      empty:
        "現時点では、記憶はまだありません。チャットボットとのやり取りを続けると、徐��に記憶が埋まっていくでしょう。",
      ...
      modal: {
        ...
        label: "記憶",
        placeholder:
          "例：ユーザー名がジョー、ユーザーが使用しているツールがOpenAfD Chatなど。",
        create: "作成する",
        save: "保存",
        cancel: "キャンセル",
      },
  ...
  customization: {
    interface: {
      title: "UI設定",
      description: "OpenAfD Chat の UI 設定を調整してください。",
    },
    branding: {
      title: "ブランディングとホワイトレーベル化",
      description:
        "OpenAfD Chatインスタンスを、独自のブランドでカスタマイズしてください。",
    },
    chat: {
      title: "チャット",
      description: "OpenAfD Chat のチャット設定をカスタマイズしてください。",
      auto_submit: {
        title: "自動音声入力送信",
    ...
    items: {
      ...
      "display-language": {
        title: "表示言語",
        description:
          "OpenAfD ChatのUIを特定の言語で表示するためのオプションを選択してください。翻訳が利用可能な場合にのみ有効です。",
      },
      logo: {
        title: "ブランドロゴ",
        description:
  ...
  "main-page": {
    ...
    workspaceSources: {
      ...
      add: "ソースを追加",
      empty:
        "まだソースがありません。\nドキュメントをアップロードするか、URLを追加してチャットにコンテキストを与えてください。",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "本人確認が必要です。",
          description:
            "アイテムを公開する前に、OpenAfD Chatコミュニティハブで認証する必要があります。",
          button: "コミュニティハブへの接続",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "パスワード保護",
      description:
        "OpenAfD Chatインスタンスをパスワードで保護します。これを忘れた場合、回復方法はないため、このパスワードを必ず保存してください。",
