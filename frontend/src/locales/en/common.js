...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    metrics_show_on_hover: "Click to only show metrics when hovering",
    ...
    usage_description: "Show token usage for this chat",
    usage_title: "Chat usage",
    usage_responses: "Responses: {{count}}",
    usage_prompt_tokens: "Prompt tokens: {{count}}",
    usage_completion_tokens: "Completion tokens: {{count}}",
    usage_total_tokens: "Total tokens: {{count}}",
  ...
  common: {
    ...
    clear: "Clear",
    defaultSkillTooltip: "Default skill",
  ...
  pdfAnalysis: {
    ...
    crossCheck: {
      ...
      sourcesCount_one: "{{count}} comparison source",
      sourcesCount_other: "{{count}} comparison sources",
      sourcesCount: "Sources checked",
  ...
  chat: {
    ...
    grounding: {
      based_on_sources: "Based on sources",
    },
  },
  "vector-workspace": {
  ...
  profile_settings: {
    ...
    current_password_description: "Required only when changing your password",
    cancel: "Cancel",
  ...
  parsedFilesMenu: {
    ...
    embedSuccess_one: "{{count}} file embedded successfully",
    embedSuccess_other: "{{count}} files embedded successfully",
    embedFailed: "Failed to embed files",
    loading: "Loading...",
    noFilesFound: "No files found",
    embedSuccess: "File embedded successfully",
  },
  admin: {
    editUser: {
      title: "Edit {{username}}",
  ...
  sidebar: {
    ...
    database: {
      ...
      dipResults: "Election results",
      noDipResults: "No election results",
      noSpeeches: "No speeches found",
      partyFilter: "Party",
      search: "Search",
      select: "Select",
      selectAll: "Select all",
      speechResults: "Speeches",
      speechSearch: "Search speeches",
      stateFilter: "State",
      statMandates: "Mandates",
      statSpeeches: "Speeches",
      statVotes: "Votes",
      tabDrucksachen: "Documents",
      tabPoliticians: "Politicians",
    ...
    filesystem: {
      ...
      directoryConnected: "Directory connected",
      directoryAccessDescription:
        "The AI in this workspace has access to all files in this directory.",
      connecting: "Connecting...",
      connect: "Connect",
      upload: "Upload",
      searchPlaceholder: "Search files...",
      dropHere: "Drop files here",
      dropHint: "PDF, documents, images, videos and more",
      emptyTitle: "No files yet",
      emptyHint: "Upload files or drag and drop them here",
      uploadFirst: "Upload first file",
      noSearchResults: "No files found",
      uploadSuccess_one: "{{count}} file uploaded",
      uploadSuccess_other: "{{count}} files uploaded",
      uploadFailed: "Upload failed",
      download: "Download",
      preview: "Preview",
      addedAsContext: "Added as context",
      contextFailed: "Could not add file as context",
      ...
      folderEmpty: "Empty",
      fileCount: "files",
      sysInfoPlatform: "Platform",
      sysInfoRamFree: "Free RAM",
      sysInfoStorage: "Storage",
      sysInfoStorageFree: "Free storage",
