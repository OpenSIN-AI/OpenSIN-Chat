...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description: "OpenSIN Chat can work with many LLM providers. This will be the service which handles chatting."
    },
    userSetup: {
      title: "User Setup",
  ...
  providerSettings: {
    ...
    lemonade: {
      ...
      baseUrlTooltip2: "You must have enabled the Lemonade TCP support for this to work.",
      learnMore: "Learn more",
      baseUrlPlaceholder: "http://localhost:13305",
      modelContextWindow: "Model context window",
      modelContextWindowTooltip: "The maximum number of tokens that can be used for a model context window. This must be set to a value that is supported by the model.",
      ...
      uninstallConfirm: "Are you sure you want to uninstall this model? You will need to download it again to use it.",
      downloadConfirm: "Are you sure you want to download this model? It is {{fileSize}} in size and may take a while to download."
    },
    cometApi: {
      ...
      modelInputHelp: "You can type the model id directly or pick from suggestions.",
      advancedSettings: "advanced settings",
      streamTimeout: "Stream Timeout (ms)",
      timeoutDescription: "Timeout value between token responses to auto-timeout the stream."
    },
    genericOpenAi: {
      baseUrl: "Base URL",
    ...
    geminiEmbedding: {
      ...
      outputDimensionsTooltip: "The number of dimensions the resulting output embeddings should have if it supports multiple dimensions output.",
      outputDimensionsTooltip2: "Leave blank to use the default dimensions for the selected model.",
    ...
    groqAi: {
      ...
      modelSelection: "Chat Model Selection",
      loadingModels: "-- loading available models --",
      enterApiKeyHint: "Enter a valid API key to view all available models for your account.",
      availableModels: "Available models",
      selectModelHint: "Select the GroqAI model you want to use for your conversations."
    },
    moonshotAi: {
      apiKey: "API Key",
    ...
    xAi: {
      ...
      enterApiKeyHint: "Enter a valid API key to view all available models for your account.",
      availableModels: "Available models",
      selectModelHint: "Select the xAI model you want to use for your conversations."
    },
    zAi: {
      apiKey: "Z.AI API Key",
      ...
      enterApiKeyHint: "Enter a valid API key to view all available models for your account.",
      availableModels: "Available models",
      selectModelHint: "Select the Z.AI model you want to use for your conversations."
    },
    azureAiEmbedding: {
      ...
      embeddingDeploymentNamePlaceholder: "Azure OpenAI embedding model deployment name"
    },
    openAiEmbedding: {
      apiKey: "API Key",
      apiKeyPlaceholder: "OpenAI API Key",
  ...
  chat_window: {
    ...
    attach_menu: {
      ...
      no_workspace: "No workspace available. Send a message first to create a workspace.",
      add_success: "Source added to workspace",
      add_failed: "Could not add source",
      url_hint: "Paste the URL of a website or YouTube video to add it as a source.",
    ...
    memories: {
      ...
      toggle: {
        ...
        description: "Allow your assistant to recall facts about you or this workspace and use them in conversations"
      },
      auto_extraction: {
        label: "Automatic Memories",
        description: "Have your assistant automatically create memories in the background"
      },
      menu: {
        edit: "Edit",
        delete: "Delete",
      ...
      modal: {
        ...
        label: "Memory",
        placeholder: "e.g. User's name is Joe, User works on OpenSIN Chat, etc.",
        create: "Create",
        save: "Save",
        cancel: "Cancel"
      }
  ...
  common: {
    ...
    stopped: "Stopped",
    search: "Search",
    username_requirements: "Username must be 2-32 characters, start with a lowercase letter, and only contain lowercase letters, numbers, underscores, hyphens, and periods.",
    loading: "Loading",
    refresh: "Refresh",
    ...
    docsNotFoundDesc: "The requested document does not exist or has been moved.",
    ...
    docsLandingSubtitle: "Everything you need to understand, operate, and extend OpenSIN Chat.",
  ...
  webSearch: {
    ...
    getBingWebSearchSubscription: "You can get a Bing Web Search API subscription key",
    ...
    bingSetupStep2: "Create a new Azure account or sign in with an existing one.",
    bingSetupStep3: 'Navigate to the "Create a resource" section and search for "Grounding with Bing Search".',
    bingSetupStep4: 'Select the "Grounding with Bing Search" resource and create a new subscription.',
    bingSetupStep5: "Choose the pricing tier that suits your needs.",
    bingSetupStep6: "Obtain the API key for your Grounding with Bing Search subscription.",
    ...
    duckduckgoNoConfig: "DuckDuckGo is ready to use without any additional configuration.",
    fromExa: "from Exa.",
    exaApiKey: "Exa API Key",
    fromPerplexity: "from Perplexity.",
    perplexityApiKey: "Perplexity API Key",
    vaneNoConfig: "Vane runs as a local sidecar container and requires no API key. The endpoint is configured via the VANE_API_URL environment variable (default: http://vane:3000). Complete the one-time model setup at the Vane web UI first."
  },
  ollama: {
    advancedSettings: "advanced settings",
    showAdvanced: "Show",
    ...
    keepAliveTooltip: "Choose how long Ollama should keep your model in memory before unloading.",
    ...
    contextWindowTooltip: "Specify the maximum number of tokens that can be used for the model context window.",
    contextWindowTooltip2: "If you leave this field blank, the context window limit will be auto-detected from the model and applied to all chats. If auto-detection fails, a fallback context window limit of 4096 will be used.",
    contextWindowTooltipImportant: "Important",
    contextWindowTooltipImportantText: "Some models have very large context windows using the full context window limit can dramatically increase the memory usage of your system. For this reason, we will automatically cap the context window limit to 16,384 tokens if the model supports more than that and no value is specified.",
    contextWindowTooltipFallback: "If an invalid value is entered, OpenSIN Chat will handle this for you so that chats do not fail.",
    ...
    selectModelHelp: "Select the Ollama model you want to use. Models will load after entering a valid Ollama URL.",
    yourLoadedModels: "Your loaded models",
    chooseModelHelp: "Choose the Ollama model you want to use for your conversations.",
    baseUrlPlaceholder: "http://127.0.0.1:11434",
    autoDetected: "(auto-detected)"
  },
  ollamaEmbedding: {
    maxChunkLengthLabel: "Max embedding chunk length",
    maxChunkLengthTooltip: "Maximum length of text chunks, in characters, for embedding.",
    ...
    batchSizeTooltip: "Number of text chunks to embed in parallel. Higher values improve speed but use more memory. Default is 1.",
    batchSizePlaceholder: "1",
    batchSizeHelp: "Increase this value to process multiple chunks simultaneously for faster embedding.",
    ...
    loadingModels: "--loading available models--",
    enterUrlFirst: "Enter Ollama URL first",
    selectModelHelp: "Select the Ollama model for embeddings. Models will load after entering a valid Ollama URL.",
    yourLoadedModels: "Your loaded models",
    chooseModelHelp: "Choose the Ollama model you want to use for generating embeddings."
  },
  ...
  lmStudioEmbedding: {
    ...
    authTokenTooltipBearer: "Bearer",
    authTokenTooltipPart2: "Auth Token for interacting with your LM Studio server.",
    authTokenTooltipPart3: "Used only if running LM Studio behind an authentication server.",
  ...
  lemonadeEmbedding: {
    ...
    yourLoadedModels: "Your loaded models",
    selectModelHelp: "Select the Lemonade model you want to use for embeddings.",
    maxChunkLengthLabel: "Max embedding chunk length",
    maxChunkLengthTooltip: "Maximum length of text chunks, in characters, for embedding.",
    maxChunkLengthPlaceholder: "8192",
    apiKeyLabel: "API Key",
  ...
  agentLLMItem: {
    ...
    setupDescription: "To use {{name}} as this workspace's agent LLM you need to set it up first.",
    cancel: "Cancel",
  ...
  sqlConnection: {
    ...
    descriptionEdit: "Update the connection information for your database below.",
    descriptionNew: "Add the connection information for your database below and it will be available for future SQL agent calls.",
    ...
    warningDoesNotPrevent2: "prevent a hallucination from still deleting data. Only connect with a user who has",
    ...
    duplicateError: 'A connection with the name "{{name}}" already exists. Please choose a different name.',
    fillAllFields: "Please fill out all the fields above.",
    validationFailed: "Failed to validate connection. Please check your connection details.",
    connectionFailed: "Failed to establish database connection. Please check your connection details."
  },
  pdfAnalysis: {
    crossCheck: {
      ...
      claimsPlaceholder: "e.g. The funding program ends on 12/31/2026\nResponsibility lies with the state office",
      ...
      deepWebLabel: "Deep web research: Agents additionally research autonomously on the web",
      submitError1: "Please provide at least one claim or fact ID.",
      submitError2: "Please add at least one comparison source OR enable deep web research.",
      submitBusy: "Starting…",
  ...
  chat: {
    ...
    mode: {
      ...
      automatic: {
        title: "Agent",
        description: "will automatically use tools if the model and provider support native tool calling.<br />If native tooling is not supported, you will need to use the @agent command to use tools."
      },
      chat: {
        title: "Chat",
        description: "will provide answers with the LLM's general knowledge <b>and</b> document context that is found.<br />You will need to use the @agent command to use tools."
      },
      query: {
        title: "Query",
        description: "will provide answers <b>only</b> if document context is found.<br />You will need to use the @agent command to use tools."
      }
    },
    history: {
      title: "Chat History",
    ...
    prompt: {
      title: "System Prompt",
      description: "The prompt that will be used on this workspace. Define the context and instructions for the AI to generate a response. You should provide a carefully crafted prompt so the AI can generate a relevant and accurate response.",
      history: {
  ...
  agent: {
    ...
    skill: {
      ...
      web: {
        title: "Web Search",
        description: "Enable your agent to search the web to answer your questions by connecting to a web-search (SERP) provider."
      },
      sql: {
        title: "SQL Connector",
      ...
      filesystem: {
        ...
        description: "Enable your agent to read, write, search, and manage files within a designated directory. Supports file editing, directory navigation, and content search.",
        ...
        skills: {
          ...
          "write-text-file": {
            ...
            description: "Create new text files or overwrite existing text files"
          },
          "edit-file": {
            title: "Edit File",
      ...
      createFiles: {
        ...
        description: "Enable your agent to create binary document formats like PowerPoint presentations, Excel spreadsheets, Word documents, and PDFs. Files can be downloaded directly from the chat window.",
        configuration: "Available Document Types",
        skills: {
          "create-text-file": {
            title: "Text Files",
            description: "Create text files with any content and extension (.txt, .md, .json, .csv, etc.)"
          },
          "create-pptx": {
            title: "PowerPoint Presentations",
            description: "Create new PowerPoint presentations with slides, titles, and bullet points"
          },
          "create-pdf": {
            title: "PDF Documents",
            description: "Create PDF documents from markdown or plain text with basic styling"
          },
          "create-xlsx": {
            title: "Excel Spreadsheets",
            description: "Create Excel documents for tabular data with sheets and styling"
          },
          "create-docx": {
            title: "Word Documents",
            description: "Create Word documents with basic styling and formatting"
          },
          "read-pdf-file": {
            title: "Read PDF",
      ...
      image_generation: {
        ...
        description: "Generate images using any OpenAI-compatible image generation API. Configure the endpoint, API key, and model below.",
        base_url: {
          label: "Base URL",
          required: "(required)",
      ...
      gmail: {
        title: "GMail",
        description: "Enable your agent to interact with Gmail - search emails, read threads, compose drafts, send emails, and manage your inbox. <a>Read the documentation</a>.",
        ...
        categories: {
          ...
          threads: {
            ...
            description: "Manage email threads - mark read/unread, archive, trash"
          },
          account: {
      ...
      googleCalendar: {
        ...
        description: "Enable your agent to interact with Google Calendar - view calendars, get events, create and update events, and manage RSVPs. <a>Read the documentation</a>.",
        ...
        skills: {
          ...
          getUpcomingEvents: {
            ...
            description: "Get events for today, this week, or this month using simple keywords"
          },
          quickAdd: {
            title: "Quick Add Event",
            description: "Create an event from natural language (e.g., 'Meeting tomorrow at 3pm')"
          },
          createEvent: {
            title: "Create Event",
            description: "Create a new event with full control over all properties"
          },
          updateEvent: {
            title: "Update Event",
      ...
      outlook: {
        title: "Outlook",
        description: "Enable your agent to interact with Microsoft Outlook - search emails, read threads, compose drafts, send emails, and manage your inbox via Microsoft Graph API. <a>Read the documentation</a>.",
        ...
        skills: {
          ...
          createDraft: {
            title: "Create Draft",
            description: "Create a new draft email or draft reply to an existing message"
          },
          updateDraft: {
            title: "Update Draft",
            description: "Update an existing draft email"
          ...
          sendEmail: {
            title: "Send Email",
            description: "Send a new email or reply to an existing message immediately"
          },
          getMailboxStats: {
            title: "Mailbox Stats",
    ...
    mcp: {
      ...
      "refresh-confirm": "Are you sure you want to refresh the list of MCP servers? This will restart all MCP servers and reload their tools.",
    ...
    settings: {
      ...
      "max-tool-calls": {
        ...
        description: "The maximum number of tools an agent can chain to generate a single response. This prevents runaway tool calls and infinite loops."
      },
      "intelligent-skill-selection": {
        title: "Intelligent Skill Selection",
        "beta-badge": "Beta",
        description: "Enable unlimited tools and cut token usage by up to 80% per query — OpenSIN Chat automatically selects the right skills for every prompt.",
        "max-tools": {
          title: "Max Tools",
          description: "The maximum number of tools to select for each query. We recommend setting this to higher values for larger context models."
        }
      },
      "clarifying-questions": {
        title: "Allow agent to ask clarifying questions",
        "beta-badge": "BETA",
        description: "When enabled, agents can pause to ask short clarifying questions if your prompt is ambiguous.",
        "max-per-turn": {
          title: "Max questions per turn",
          description: "How many clarifying questions the agent may ask in a single survey."
        }
      }
    }
  },
  agentBuilder: {
    summarizeDescription: "When enabled, long webpage content will be automatically summarized to reduce token usage.",
    summarizeNote: "Note: This may affect data quality and remove specific details from the original content.",
    finishNodeDescription: "This is the end of your agent flow. All steps above will be executed in sequence.",
    fileNode: {
      operation: "Operation",
      readFile: "Read File",
    ...
    flowInfoNode: {
      flowName: "Flow Name",
      flowNameDescription: "It is important to give your flow a name that an LLM can easily understand.",
      flowNameExamples: '"SendMessageToDiscord", "CheckStockPrice", "CheckWeather"',
      enterFlowName: "Enter flow name",
      description: "Description",
      descriptionExplanation: "It is equally important to give your flow a description that an LLM can easily understand. Be sure to include the purpose of the flow, the context it will be used in, and any other relevant information.",
  ...
  preview: {
    ...
    empty: "No content to preview. Generate a report or document to view it here.",
    title: "Preview",
  ...
  customization: {
    ...
    branding: {
      ...
      description: "White-label your OpenSIN Chat instance with custom branding."
    },
    chat: {
      title: "Chat",
    ...
    items: {
      ...
      "support-email": {
        title: "Support Email",
        description: "Set the support email address that should be accessible by users when they need help."
      },
      "app-name": {
        title: "Name",
      ...
      "display-language": {
        ...
        description: "Select the preferred language to render OpenSIN Chat's UI in - when translations are available."
      },
      logo: {
        title: "Brand Logo",
      ...
      "render-html": {
        ...
        description: "Render HTML responses in assistant responses.\nThis can result in a much higher fidelity of response quality, but can also lead to potential security risks."
      }
    }
  },
  api: {
    title: "API Keys",
    description: "API keys allow the holder to programmatically access and manage this OpenSIN Chat instance.",
    ...
    modal: {
      ...
      helper: "Once created the API key can be used to programmatically access and configure this OpenSIN Chat instance.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM Preference",
    description: "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else OpenSIN Chat will not function properly.",
  ...
  "model-router": {
    title: "Model Routers",
    description: "Model routers let you define rules to automatically route chat messages to different LLM providers and models based on conditions.",
    table: {
      name: "Name",
      fallback: "Fallback",
      rules: "Rules",
    ...
    rules: {
      ...
      description: "Define the rules that determine when and how chat messages go to specific providers and models.",
      "add-rule": "Add Rule",
  ...
  transcription: {
    ...
    "warn-start": "Using the local whisper model on machines with limited RAM or CPU can stall OpenSIN Chat when processing media files.",
  ...
  embedding: {
    ...
    "desc-end": "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which OpenSIN Chat can use to process.",
    provider: {
  ...
  vector: {
    ...
    description: "These are the credentials and settings for how your OpenSIN Chat instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description: "Connect your OpenSIN Chat instance to Telegram so you can chat with your workspaces from any device.",
    setup: {
      step1: {
        title: "Step 1: Create your Telegram bot",
        description: "Open @BotFather in Telegram, send <code>/newbot</code> to <code>@BotFather</code>, follow the prompts, and copy the API token.",
      ...
      step2: {
        ...
        description: "Paste the API token you received from @BotFather to connect your bot.",
        "bot-token": "Bot Token",
      ...
      security: {
        ...
        description: "For additional security, configure these settings in @BotFather.",
  ...
  security: {
    ...
    password: {
      ...
      description: "Protect your OpenSIN Chat instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description: "This is your configuration for how connected third party providers and OpenSIN Chat handle your data.",
  ...
  connectors: {
    ...
    github: {
      ...
      files_collected: "{{files}} {{filePlural}} collected from {{author}}/{{repo}}:{{branch}}. Output folder is {{destination}}.",
    ...
    upload: {
      ...
      "privacy-notice": "These files will be uploaded to the document processor running on this OpenSIN Chat instance. These files are not sent or shared with a third party."
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1: "When you <b>pin</b> a document in OpenSIN Chat we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      ...
      pin_explained_block3: "If you are not getting the answers you desire from OpenSIN Chat by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it"
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1: "When you <b>watch</b> a document in OpenSIN Chat we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
  ...
  communityHub: {
    title: "Community Hub",
    trendingDescription: "Share and collaborate with the OpenSIN Chat community.",
    importDescription: "Import items from the OpenSIN Chat Community Hub to enhance your instance with community-created prompts, skills, and commands.",
    auth: {
      ...
      userItems: {
        ...
        createdByMeDescription: "Items you have created and shared publicly on the OpenSIN Chat Community Hub.",
        noItemsCreated: "You haven't created any items yet.",
        itemsByTeam: "Items by team",
        itemsByTeamDescription: "Public and private items shared with teams you belong to.",
    ...
    import: {
      ...
      unsupported: {
        ...
        description: "We found an item in the community hub, but we don't know what it is or it is not yet supported for import into OpenSIN Chat.",
        itemId: "The item ID is:",
        itemType: "The item type is:",
        contactSupport: "Please contact support via email if you need help importing this item.",
  ...
  community_hub: {
    publish: {
      ...
      agent_flow: {
        ...
        flow_steps_description: "The steps the agent will follow when the flow is triggered.",
      ...
      generic: {
        unauthenticated: {
          ...
          description: "You need to authenticate with the OpenSIN Chat Community Hub before publishing items.",
  ...
  scheduledJobs: {
    ...
    description: "Create recurring AI tasks that run on a schedule. Each job runs a prompt with optional tools and saves the result for review.",
    newJob: "New Job",
    loading: "Loading...",
  ...
  drupalWiki: {
    ...
    baseUrlPlaceholder: "eg: https://mywiki.drupal-wiki.net, https://drupalwiki.mycompany.tld, etc...",
    spaceIdsLabel: "Drupal Wiki Space IDs",
    spaceIdsDescription: "Comma separated Space IDs you want to extract. See the <a>manual</a> on how to retrieve the Space IDs. Be sure that your 'API-Token User' has access to those spaces.",
    spaceIdsPlaceholder: "eg: 12,34,69",
    apiTokenLabel: "Drupal Wiki API Token",
    apiTokenTooltip: "You need to provide an API token for authentication. See the Drupal Wiki <a>manual</a> on how to generate an API-Token for your user.",
    apiTokenDescription: "Access token for authentication.",
    apiTokenPlaceholder: "pat:123",
    submitButton: "Submit",
    collectingButton: "Collecting pages...",
    collectingDescription: "Once complete, all pages will be available for embedding into workspaces.",
    toastFetching: "Fetching all pages for the given Drupal Wiki spaces - this may take a while.",
    toastSuccess: "Pages collected from Drupal Wiki spaces {{spaceIds}}. Output folder is {{destination}}."
  },
  fileUploadWarning: {
    ...
    description: "Your workspace is using {{tokenCount}} of {{maxTokens}} available tokens. We recommend keeping usage below {{limit}}% to ensure the best chat experience. Adding {{fileCount}} more {{fileWord}} would exceed this limit. <a>Learn more about context windows \u2192</a>",
  ...
  providerKeyStatus: {
    section: {
      ...
      subtitle: "Fallback active = provider runs with a safe placeholder key (no crash, but no real key set)."
    },
    refresh: {
    ...
    storagePath: {
      problem: "Storage path problem detected: {{path}} (exists: {{exists}}, writable: {{writable}}, hotdir: {{hotdir}}).",
      ok: "ok",
      missing: "missing"
    },
  ...
  pgVector: {
    connectionString: {
      ...
      tooltip: {
        intro: "This is the connection string for the Postgres database in the format of",
        permissions: "The user for the database must have the following permissions:",
        perm1: "Read access to the database",
        perm2: "Read access to the database schema",
        perm3: "Create access to the database",
        extension: "You must have the pgvector extension installed on the database."
      }
    },
    tableName: {
      ...
      tooltip: {
        intro: "This is the name of the table in the Postgres database that will store the vectors.",
        default: "By default, the table name is",
        warning: "This table must not already exist on the database - it will be created automatically."
      }
    }
  },
  defaultSystemPrompt: {
    title: "Default System Prompt",
    subtitle: "This is the default system prompt that will be used for new workspaces.",
    label: "System Prompt",
    description: {
      part1: "A system prompt provides instructions that shape the AI's responses and behavior. This prompt will be automatically applied to all newly created workspaces. To change the system prompt of a",
      specificWorkspace: "specific workspace",
      part2: ", edit the prompt in the",
      workspaceSettings: "workspace settings",
      part3: ". To restore the system prompt to our sane default, leave this field empty and save changes."
    },
    variables: {
  ...
  newUserModal: {
    ...
    error: "Error: {{error}}",
    afterCreate: "After creating a user they will need to login with their initial login to get access.",
    submit: "Add user"
  },
  liteLLM: {
    baseUrl: {
    ...
    modelSelection: {
      ...
      yourLoadedModels: "Your loaded models",
      tooltip: {
        intro: "Be sure to select a valid embedding model. Chat models are not embedding models. See",
        linkText: "this page",
  ...
  kokoro: {
    ...
    voiceModel: {
      ...
      unreachable: "Could not reach the Kokoro server to load voices. Enter a voice id manually."
    }
  },
  webScrapingNode: {
    ...
    querySelectorHelp: "Enter a valid CSS selector to scrape the content of the page.",
  ...
  agentSkill: {
    ...
    learnMore: "Learn more →",
    description: {
      part1: "Agent skills unlock new capabilities for your OpenSIN Chat workspace via",
  ...
  admin: {
    ...
    systemPromptVariables: {
      ...
      page: {
        ...
        deleteConfirm: 'Are you sure you want to delete the variable "{{key}}"?\nThis action is irreversible.',
    ...
    newWorkspaceModal: {
      ...
      placeholder: "My workspace",
      error: "Error: {{error}}",
      adminOnlyHint: "After creating this workspace only admins will be able to see it. You can add users after it has been created.",
      cancel: "Cancel",
  ...
  invite: {
    newUser: {
      ...
      error: "Error: {{error}}",
      afterCreateHint: "After creating your account you will be able to login with these credentials and start using workspaces.",
  ...
  audioPreference: {
    stt: {
      ...
      description: "Here you can specify what kind of text-to-speech and speech-to-text providers you would want to use in your OpenSIN Chat experience. By default, we use the browser's built in support for these services, but you may want to use others.",
      ...
      genericOpenaiDesc: "Connect to any OpenAI-compatible STT service via a custom configuration."
    },
    tts: {
      title: "Text-to-speech Preference",
      description: "Here you can specify what kind of text-to-speech providers you would want to use in your OpenSIN Chat experience. By default, we use the browser's built in support for these services, but you may want to use others.",
      ...
      kokoro: "Kokoro",
      kokoroDesc: "Connect to a self-hosted kokoro-fastapi server for high-quality open-source voices.",
      openaiCompatible: "OpenAI Compatible",
      openaiCompatibleDesc: "Connect to an OpenAI compatible TTS service running locally or remotely.",
      nvidiaNim: "NVIDIA NIM",
      nvidiaNimDesc: "Use NVIDIA NIM's hosted text-to-speech API with high-quality voices."
    }
  },
  embedChats: {
    chatRow: {
  ...
  mobileConnections: {
    ...
    description: "These are the devices that are connected to your desktop application to sync chats, workspaces, and more.",
    ...
    connectionModal: {
      ...
      description: "OpenSIN Chat for mobile allows you to connect to your workspace's chats, threads, tools, and documents for you to use on the go.\n\nRun with local models on your phone privately or relay chats directly to this instance seamlessly.",
      scanHint: "Scan the QR code with the OpenSIN Chat Mobile app to enable live sync of your workspaces, chats, threads and documents.",
      learnMore: "Learn more"
    }
  },
  attachments: {
    ...
    willBeAttachedPrompt: "{{name}} will be attached to this prompt. It will not be embedded into the workspace permanently.",
    wasEmbedded: "{{name}} was uploaded and embedded into this workspace. It will be available for RAG chat now.",
  ...
  setupProvider: {
    saveFailed: "Failed to save {{name}} settings: {{error}}",
    title: "{{name}} Settings",
    description: "To use {{name}} as this workspace's LLM you need to set it up first.",
    cancel: "Cancel",
  ...
  inviteRow: {
    deactivateConfirm: "Are you sure you want to deactivate this invite?\nAfter you do this it will no longer be usable.\n\nThis action is irreversible.",
    disabled: "Disabled",
  ...
  codeSnippetModal: {
    ...
    scriptTagDescription: "Have your workspace chat embed function like a help desk chat bottom in the corner of your website.",
  ...
  importedSkillConfig: {
    ...
    confirmDeleteSkill: "Are you sure you want to delete this skill? This action cannot be undone.",
  ...
  customSiteSettings: {
    updateSuccess: "Site preferences updated! They will reflect on page reload.",
  ...
  agentConfig: {
    ...
    configureDescription: "Customize and enhance the default agent's capabilities by enabling or disabling specific skills. These settings will be applied across all workspaces.",
  ...
  vectorSearch: {
    ...
    defaultDescription: "This is the fastest performance, but may not return the most relevant results leading to model hallucinations.",
    accuracyOptimizedDescription: "LLM responses may take longer to generate, but your responses will be more accurate and relevant."
  },
  uploadProgress: {
