...
vi.mock("@phosphor-icons/react/dist/csr/Sparkle", () => ({
  default: (props) => <svg data-testid="phosphor-sparkle-icon" {...props} />,
  Sparkle: (props) => <svg data-testid="phosphor-sparkle-icon" {...props} />,
}));
