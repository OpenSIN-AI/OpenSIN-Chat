...
export function SendPromptButton({ formRef, promptInput, isDisabled }) {
  return (
    <button
      ref={formRef}
      type="submit"
...
export function EnhancePromptButton({ promptInput, setPromptInput, isStreaming }) {
