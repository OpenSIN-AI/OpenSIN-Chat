...
function VersionDropdown({ versions, activeVersion, onSelect }) {
...
function ThreeDotsMenu({ previewData, onAddToSources }) {
...
export default function PreviewSidebar() {
  ...
  return (
    <ChatSidebar isOpen={sidebarOpen}>
      <div className="ml-4 w-[350px] bg-zinc-900 light:bg-white light:border-2 light:border-slate-300 md:rounded-[16px] flex flex-col overflow-hidden mt-[72px] max-h-[calc(100%-88px)]">
        {/* Header */}
