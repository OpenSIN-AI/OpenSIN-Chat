...
const Actions: any = ({
  ...
  return (
    <div
      className={`flex ${role === "user" ? "w-fit" : "w-full"} flex-wrap items-center gap-y-1 ${role === "user" ? "justify-end" : "justify-between"} pt-1 md:h-auto transition-all duration-200`}
    >
  ...
  return (
    <div className="relative flex items-center justify-center h-7 w-7">
      <button
        ...
        className="flex h-7 w-7 items-center justify-center rounded-md text-zinc-500 transition-colors hover:bg-white/[0.06] hover:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 light:text-slate-500 light:hover:bg-slate-100"
  ...
  return (
    <div className="relative flex items-center justify-center h-7 w-7">
      <button
        ...
        className="flex h-7 w-7 items-center justify-center rounded-md border-none text-zinc-500 transition-colors hover:bg-white/[0.06] hover:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 light:text-slate-500 light:hover:bg-slate-100"
