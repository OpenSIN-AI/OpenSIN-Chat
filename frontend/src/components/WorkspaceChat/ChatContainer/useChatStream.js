...
export default function useChatStream({
  ...
  // Keep a ref to sendCommand so the pending-message effect always calls
  // the latest version instead of a stale closure from first render.
  ...
  useEffect(() => {
    async function fetchReply() {
      // Read the latest chatHistory from the ref instead of capturing the
      // stale closure value. This prevents the effect from firing twice
