import * as TTS from "@openafd/piper-tts-web";

/** @type {import("@openafd/piper-web-tts").TtsSession | null} */
 ...
 * @property {import('@openafd/piper-web-tts').VoiceId} voiceId - the voiceID key to use.
 ...
 * @property {('voices')} type
 * @property {[import("@openafd/piper-tts-web/dist/types")['Voice']]} voices - available voices in array
 */
