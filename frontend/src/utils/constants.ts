...
export const AUTH_TOKEN = "openafd_authToken";
export const AUTH_TIMESTAMP = "openafd_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "openafd_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "openafd_pinned_document_alert";
export const SEEN_WATCH_ALERT = "openafd_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "openafd_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "openafd_user_prompt_input_map";
