...
// Purpose: Skill panel for enabling and configuring Outlook agent integration.
// Docs: OutlookSkillPanel.doc.md
import React, {
  useEffect,
  useState,
  useRef,
...
export default function OutlookSkillPanel({
  ...
  setHasChanges,
  hasChanges = false,
}: OutlookSkillPanelProps): JSX.Element {
  ...
  function toggleOutlookSkill(skillName: string) {
    setHasChanges?.(true);
...
interface SkillsSectionProps {
  skillCategories: ReturnType<typeof getOutlookSkills>;
