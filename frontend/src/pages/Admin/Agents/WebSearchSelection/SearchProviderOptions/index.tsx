...
// Purpose: Provider-specific option forms for each supported web search provider.
// Docs: SearchProviderOptions.doc.md
import { useTranslation } from "react-i18next";

interface SearchProviderOptionProps {
  settings?: SearchProviderSettings;
}

interface SearchProviderSettings {
  AgentSerpApiKey?: string;
  AgentSerpApiEngine?: string;
  AgentSearchApiKey?: string;
  AgentSearchApiEngine?: string;
  AgentSerperApiKey?: string;
  AgentBingSearchApiKey?: string;
  AgentBaiduSearchApiKey?: string;
  AgentSerplyApiKey?: string;
  AgentSearXNGApiUrl?: string;
  AgentTavilyApiKey?: string;
  AgentExaApiKey?: string;
  AgentPerplexityApiKey?: string;
  [key: string]: string | undefined;
}

interface SerpApiEngine {
  name: string;
  value: string;
}

const SerpApiEngines: SerpApiEngine[] = [
...
export function SerpApiOptions({ settings }: SearchProviderOptionProps) {
...
const SearchApiEngines: SerpApiEngine[] = [
  { name: "Google Search", value: "google" },
  { name: "Google Maps", value: "google_maps" },
...
export function SearchApiOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function SerperDotDevOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function BingSearchOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function BaiduSearchOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function SerplySearchOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function SearXNGOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <div className="flex gap-x-4">
      <div className="flex flex-col w-60">
...
export function TavilySearchOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function ExaSearchOptions({ settings }: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export function PerplexitySearchOptions({
  settings,
}: SearchProviderOptionProps) {
  const { t } = useTranslation();
  return (
    <>
      <p className="text-sm text-white/60 my-2">
...
export type { SearchProviderSettings, SearchProviderOptionProps };
