...
// Purpose: Skill panel for enabling and configuring Google Calendar agent integration.
// Docs: GoogleCalendarSkillPanel.doc.md
import React, {
  useEffect,
  useState,
  useRef,
...
interface GoogleCalendarSkillPanelProps {
  title: string;
  skill: string;
...
export default function GoogleCalendarSkillPanel({
  ...
  setHasChanges,
  hasChanges = false,
}: GoogleCalendarSkillPanelProps): JSX.Element {
  ...
  function toggleGoogleCalendarSkill(skillName: string) {
    setHasChanges?.(true);
        ...
        <div className="flex w-full justify-between items-center">
          <div className="flex items-center gap-x-2">
            <img
              ...
              alt={t("skills.googleCalendar.alt")}
              width={24}
              height={24}
            />
        ...
        <div className="p-3 flex flex-col gap-y-4 border-t border-theme-sidebar-border/50">
          <div className="flex flex-col gap-y-2">
            ...
            <input
              ...
              placeholder={t("skills.googleCalendar.placeholder.deploymentId")}
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <input
              ...
              placeholder={t("skills.googleCalendar.placeholder.apiKey")}
              className="w-full px-3 py-2 bg-theme-bg-primary border border-theme-sidebar-border rounded-lg text-theme-text-primary text-sm placeholder:text-theme-text-secondary/50"
            />
          </div>
          {!isConfigured && (
...
interface SkillsSectionProps {
  skillCategories: ReturnType<typeof getGoogleCalendarSkills>;
...
interface SkillRowProps {
  skill: { title: string; description: string; name: string };
  disabled: boolean;
  onToggle: () => void;
}
...
interface HiddenFormInputsProps {
  disabledSkills: string[];
  deploymentId: string;
  apiKey: string;
}
