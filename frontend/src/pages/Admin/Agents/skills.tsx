...
type SkillsMap = Record<string, SkillDefinition>;

export const getDefaultSkills = (t: TFunction): SkillsMap => ({
  "rag-memory": {
...
export const getAppIntegrationSkills = (t: TFunction): SkillsMap => ({
  "gmail-agent": {
