...
const ENABLED_PROVIDERS = [
  "openai", "anthropic", "lmstudio", "ollama", "localai", "groq", "azure",
  "koboldcpp", "togetherai", "openrouter", "novita", "mistral", "perplexity",
  "textgenwebui", "generic-openai", "bedrock", "fireworksai", "deepseek",
  "ppio", "litellm", "apipie", "xai", "nvidia-nim", "opencode-zen", "gemini",
  "moonshotai", "cometapi", "foundry", "zai", "giteeai", "cohere",
  "docker-model-runner", "privatemode", "sambanova", "lemonade", "minimax",
  "cerebras", "huggingface", "dpais",
];
const WARN_PERFORMANCE = [
  "lmstudio", "koboldcpp", "ollama", "localai", "textgenwebui",
  "docker-model-runner",
];

const LLM_DEFAULT: LLMProvider = {
  name: "System Default",
  value: "none",
...
export default function AgentLLMSelection({
  ...
  workspace,
  setHasChanges,
}: AgentLLMSelectionProps): JSX.Element {
  ...
  function updateLLMChoice(selection: string) {
    setSearchQuery("");
            ...
            <div className="w-full flex flex-col gap-y-1">
              <div className="flex items-center sticky top-0 z-10 border-b border-[#9CA3AF] mx-4 bg-theme-settings-input-bg">
                ...
                <input
                  ...
                  name="llm-search"
                  autoComplete="off"
                  placeholder={t("common.searchLLMProvidersAvailable")}
