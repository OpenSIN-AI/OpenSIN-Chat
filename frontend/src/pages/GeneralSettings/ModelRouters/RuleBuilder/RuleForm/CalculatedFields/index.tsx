...
function createProperties(t: any): PropertyOption[] {
  return [
    {
      value: "promptContent",
...
function createStringComparators(t: any): ComparatorOption[] {
  return [
...
function createNumericComparators(t: any): ComparatorOption[] {
  return [
...
function comparatorsFor(t: any, property: string) {
  return NUMERIC_PROPERTIES.includes(property)
    ? createNumericComparators(t)
    : createStringComparators(t);
}

function valuePlaceholder(t: any, property: string, comparator: string) {
...
function valueHelp(t: any, property: string, comparator: string) {
...
export default function CalculatedFields({
  ...
  const updateCondition = (index: number, changes: Partial<Condition>) => {
    setConditions((prev) =>
...
function ConditionRow({
  ...
  condition: Condition;
  showLabels: boolean;
  logicBadge: React.ReactNode;
  onChange: (changes: Partial<Condition>) => void;
  onRemove: (() => void) | null;
}) {
  const { t } = useTranslation();
