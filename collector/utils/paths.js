...
// Purpose: Centralized path helpers for the collector with STORAGE_DIR fallback.
// Docs: collector/utils/paths.js.doc.md
const fs = require("fs");
...
/**
 * Diagnostic snapshot of the path configuration — used by status endpoints
 * so misconfigured deployments (missing hotdir, unwritable storage) surface
 * in the UI instead of failing silently at upload time.
