...
> **Repos:** [OpenSIN-AI/OpenSIN-Chat](https://github.com/OpenSIN-AI/OpenSIN-Chat) · [Family-Team-Projects/OpenAfD-Chat](https://github.com/Family-Team-Projects/OpenAfD-Chat)
> **Live:** [sinchat.delqhi.com](https://sinchat.delqhi.com) · [openafd.delqhi.com](https://openafd.delqhi.com)
...
- [ ] OpenAfD-Chat: URL von `sinchat.delqhi.com` → `openafd.delqhi.com`
- [ ] OpenAfD-Chat: GitHub-Link von `OpenAfD/OpenAfD-Chat` → `Family-Team-Projects/OpenAfD-Chat`
...
- [ ] Credits: OpenAfD-Chat hat abweichenden Credits-Text

**Dateien:**
- `OpenSIN-Chat/README.md`
- `OpenAfD-Chat/README.md`
...
### P2-3: OpenAfD-Chat Dependabot-Alerts
