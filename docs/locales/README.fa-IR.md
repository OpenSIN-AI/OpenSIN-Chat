...
- [OpenSIN Chat Built-in](https://github.com/OpenSIN-AI/opensin-chat/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
- `embed`: زیرماژول برای تولید و ایجاد [ویجت قابل جاسازی وب](https://github.com/OpenSIN-AI/opensin-embed).
- `browser-extension`: زیرماژول برای [افزونه مرورگر کروم](https://github.com/OpenSIN-AI/opensin-extension).
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3AOpenSIN-AI%2Fopensin-chat%20.sendTelemetry(&type=code)
...
[![مشارکت‌کنندگان opensin](https://contrib.rocks/image?repo=OpenSIN-AI/OpenSIN-Chat)](https://github.com/OpenSIN-AI/OpenSIN-Chat/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=OpenSIN-AI/OpenSIN-Chat&type=Timeline)](https://star-history.com/#OpenSIN-AI/OpenSIN-Chat&Date)
