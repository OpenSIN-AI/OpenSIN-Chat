...
**Target audience:** Operators, admins, DevOps.

**Maintenance notes:**
- Update when auth modes change.
- Update when new secrets are introduced.
- Keep in sync with root `SECURITY.md` (vulnerability reporting).
