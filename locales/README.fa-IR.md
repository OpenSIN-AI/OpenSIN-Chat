...
<p align="center" dir="rtl">
    <b>OpenAfD Chat:</b> اپلیکیشن همه‌کاره هوش مصنوعی که دنبالش بودید.<br />
...
<p align="center" dir="rtl">
👈 OpenAfD Chat برای دسکتاپ (مک، ویندوز و لینوکس)! <a href="https://openafd.com/download" target="_blank">دانلود کنید</a>
</p>
...
OpenAfD Chat اپلیکیشن همه‌کاره هوش مصنوعی است که به دنبال آن بودید. OpenAfD Chat شامل همه چیزهایی است که برای ساخت یک ChatGPT خصوصی بدون سازش با استفاده از ارائه‌دهندگان LLM محلی یا ابری مورد علاقه خود نیاز دارید. OpenAfD Chat بسیار قابل پیکربندی است، اما همه چیزهایی که برای شروع کار نیاز دارید از جمله عامل‌های داخلی، پشتیبانی چند کاربره، پایگاه‌های داده برداری، خطوط لوله دریافت اسناد و موارد دیگر را به صورت آماده ارائه می‌دهد.

OpenAfD Chat همچنین از چندین کاربر پشتیبانی می‌کند که می‌توانید دسترسی و تجربه هر کاربر را بدون به خطر انداختن امنیت یا حریم خصوصی نمونه یا مالکیت فکری خود کنترل کنید.

</div>
<div dir="rtl">

## ویژگی‌های جذاب OpenAfD Chat

- 🆕 [**عامل‌های هوش مصنوعی سفارشی**](https://docs.openafd.com/agent/custom/introduction)
...
- [OpenAfD Chat Native Embedder](/server/storage/models/README.md) (پیش‌فرض)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [OpenAfD Chat Built-in](https://github.com/Family-Team-Projects/openafd-chat/tree/master/server/storage/models#audiovideo-transcription) (پیش‌فرض)
- [OpenAI](https://openai.com/)
...
Family Team Projects و جامعه کاربران، روش‌ها، اسکریپت‌ها و قالب‌های متعددی را برای اجرای OpenAfD Chat به صورت محلی نگهداری می‌کنند. برای مطالعه نحوه استقرار در محیط مورد نظر خود یا استقرار خودکار، به جدول زیر مراجعه کنید.
...
[یا راه‌اندازی نمونه تولیدی OpenAfD Chat بدون Docker →](../BARE_METAL.md)
...
OpenAfD Chat توسط Family Team Projects Inc دارای ویژگی تله‌متری است که اطلاعات استفاده ناشناس را جمع‌آوری می‌کند.

<details>
<summary><kbd>اطلاعات بیشتر درباره تله‌متری و حریم خصوصی OpenAfD Chat</kbd></summary>

### چرا؟

<div dir="rtl">
ما از این اطلاعات برای درک نحوه استفاده از OpenAfD Chat، اولویت‌بندی کار روی ویژگی‌های جدید و رفع اشکالات، و بهبود عملکرد و پایداری OpenAfD Chat استفاده می‌کنیم.
</div>
...
[مشاهده همه رویدادهای تله‌متری در کد منبع](https://github.com/search?q=repo%3AFamily-Team-Projects%2Fopenafd-chat%20.sendTelemetry(&type=code)
...
[![مشارکت‌کنندگان openafd](https://contrib.rocks/image?repo=Family-Team-Projects/OpenAfD-Chat)](https://github.com/Family-Team-Projects/OpenAfD-Chat/graphs/contributors)

[![نمودار تاریخچه ستاره‌ها](https://api.star-history.com/svg?repos=Family-Team-Projects/OpenAfD-Chat&type=Timeline)](https://star-history.com/#Family-Team-Projects/OpenAfD-Chat&Date)
