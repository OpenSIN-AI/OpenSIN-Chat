...
OpenSIN-AI和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行OpenSIN Chat。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
由 OpenSIN-AI 开发的 OpenSIN Chat 包含一个收集匿名使用信息的 Telemetry 功能。
...
版权所有 © 2026 [OpenSIN-AI][profile-link]。<br />
