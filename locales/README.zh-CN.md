...
- 🦾 工作区内的智能体（浏览网页、运行代码等）
- 💬 [为您的网站定制的可嵌入聊天窗口](https://github.com/OpenSIN-AI/opensin-embed/blob/main/README.md)
...
- [OpenSIN Chat内置](https://github.com/OpenSIN-AI/opensin-chat/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
- `embed`: 用于生成和创建[网页嵌入组件](https://github.com/OpenSIN-AI/opensin-embed)的子模块.
- `browser-extension`: 用于[Chrome 浏览器扩展](https://github.com/OpenSIN-AI/opensin-extension)的子模块.
...
[在源代码中查看所有信息收集活动](https://github.com/search?q=repo%3AOpenSIN-AI%2Fopensin-chat%20.sendTelemetry(&type=code)
...
[![opensin 的贡献者们](https://contrib.rocks/image?repo=OpenSIN-AI/OpenSIN-Chat)](https://github.com/OpenSIN-AI/OpenSIN-Chat/graphs/contributors)

[![Star 历史图](https://api.star-history.com/svg?repos=OpenSIN-AI/OpenSIN-Chat&type=Timeline)](https://star-history.com/#OpenSIN-AI/OpenSIN-Chat&Date)
...
本项目采用[MIT](https://github.com/OpenSIN-AI/opensin-chat/blob/master/LICENSE)许可证。
