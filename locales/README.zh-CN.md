...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的OpenSIN Chat！<a href="https://opensin.com/download" target="_blank">立即下载</a>
</p>
...
- 🦾 工作区内的智能体（浏览网页、运行代码等）
- 💬 [为您的网站定制的可嵌入聊天窗口](https://github.com/Family-Team-Projects/opensin-embed/blob/main/README.md)
...
- `embed`: 用于生成和创建[网页嵌入组件](https://github.com/Family-Team-Projects/opensin-embed)的子模块.
- `browser-extension`: 用于[Chrome 浏览器扩展](https://github.com/Family-Team-Projects/opensin-extension)的子模块.
...
[![opensin 的贡献者们](https://contrib.rocks/image?repo=Family-Team-Projects/OpenSIN-Chat)](https://github.com/Family-Team-Projects/OpenSIN-Chat/graphs/contributors)
