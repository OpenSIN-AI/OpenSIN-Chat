...
- 🆕 [**完全兼容 MCP**](https://docs.sinchat.delqhi.com/mcp-compatibility/overview)
- 🆕 [**无代码AI代理构建器**](https://docs.sinchat.delqhi.com/agent-flows/overview)
- 🖼️ **多用户实例支持和权限管理（支持封闭源和开源LLM！）**
- [**自定义人工智能代理**](https://docs.sinchat.delqhi.com/agent/custom/introduction)
