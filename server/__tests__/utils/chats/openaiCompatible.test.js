...
describe('OpenAICompatibleChat', () => {
  ...
  beforeEach(() => {
    ...
    helpers.getVectorDbClass.mockReturnValue(mockVectorDb);
    ...
    helpers.getLLMProvider.mockReturnValue(mockLLMConnector);
    helpers.resolveProviderConnector.mockResolvedValue({
