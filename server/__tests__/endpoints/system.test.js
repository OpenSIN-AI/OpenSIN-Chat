...
jest.mock("../../utils/files/logo", () => ({
  getDefaultFilename: jest.fn((darkMode = true) =>
    darkMode ? "opensin-logo-dark.png" : "opensin-logo.png",
  ),
  ...
  LOGO_FILENAME: "opensin-logo.png",
  LOGO_FILENAME_DARK: "opensin-logo-dark.png",
  isDefaultFilename: jest.fn((filename) =>
    ["opensin-logo.png", "opensin-logo-dark.png", "anythingllm-logo.png", "anythingllm-logo-dark.png"].includes(filename),
  ),
}));
