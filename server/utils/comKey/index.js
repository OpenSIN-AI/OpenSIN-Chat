...
// This keeps accidental misconfigurations of OpenSIN Chat that leave the collector port open from
...
class CommunicationKey {
  ...
  log(text, ...args) {
    consoleLogger.log(`\x1b[36m[CommunicationKey]\x1b[0m ${text}`, ...args);
  }
