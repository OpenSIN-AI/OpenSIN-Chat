 ...
 * @notice Use resolveProviderConnector instead as this function DOES NOT handle the opensin-router provider.
 * You should only use this function if you are absolutely sure you are not using the opensin-router provider ever in your code.
...
function getLLMProvider({ provider = null, model = null } = {}) {
  ...
  switch (LLMSelection) {
    ...
    case "opensin-router":
      ...
      throw new Error(
        "opensin-router provider must be resolved via OpenSINChatModelRouter class, not getLLMProvider directly.",
      );
    default:
      throw new Error(
 ...
 * handling the opensin-router provider transparently. Callers get back
