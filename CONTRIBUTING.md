...
- OpenSIN-Chat is the public repo (`OpenSIN-AI/OpenSIN-Chat`)
- Features are developed in OpenSIN-Chat first, then synced to private forks via `cp` with branding substitutions
