...
# Legacy rebrand script (OpenAfD -> OpenSIN migration) über den gesamten Tree.
...
#   - lower-case "openafd" als Storage-Key-Prefix (z. B. opensin_authToken)
#   - server/storage/opensin.db (DB-Dateiname; siehe package.json prisma:reset)
