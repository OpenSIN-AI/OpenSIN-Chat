...
// Purpose: Test extensions functionality endpoints (now under /ext/...)
...
describe("extensions functionality endpoints", () => {
  describe("POST /ext/:repo_platform/branches", () => {
    ...
    it.skip("should forward branches request for gitlab (requires collector)", async () => {
      // TODO: CollectorApi mock doesn't intercept CommonJS import; run with real collector to test.
    });

    it("should reject unsupported repo platform", async () => {
  ...
  describe("Legacy extensions functionality routes", () => {
